...
public class FIXEDASSET_AssetRevaluvation extends BaseClass {
	...
	public void get_the_test_data_for_asset_revaluation_test_data_from_excel_database_which_is_already_done_on_replacement()
	 ...
	 @And("^Get the data set id for for asset revalation creation from asset revaluation excel database$")
	    public void get_the_data_set_id_for_for_asset_revalation_creation_from_asset_revaluation_excel_database() throws Throwable {
			revaluationTestData = excelDataForAssetRevaluation.getTestdata("KUBS_FAT_UAT_012_01_DE_D1");
	    }
...
//				assetRevaluvationObj.assetRevaluationNotificationFirstRecord(), 20, 1);
    ...
    @Then("^store the asset reference number and asset item number of asset revaluation record to asset allocation excel data base$")
    public void store_the_asset_reference_number_and_asset_item_number_of_asset_revaluation_record_to_asset_allocation_excel_data_base() throws Throwable {
    	excelDataForAssetAllocation.updateTestData("KUBS_FAT_UATD_006_003_D11", "AssetReferenceNumber",
				revaluationTestData.get("AssetReferenceNumber"));
    	excelDataForAssetAllocation.updateTestData("KUBS_FAT_UATD_006_003_D11", "AssetItemNumber",
				revaluationTestData.get("AssetItemNumber"));
		}
    ...
    public void store_the_asset_reference_number_and_asset_item_number_of_asset_revaluation_record_to_asset_allocation_excel_data_base_for_the_pre_requisite_of_asset_deallocation() throws Throwable {
    	excelDataForAssetAllocation.updateTestData("KUBS_FAT_UATD_006_003_D12", "AssetReferenceNumber",
				revaluationTestData.get("AssetReferenceNumber"));
    	excelDataForAssetAllocation.updateTestData("KUBS_FAT_UATD_006_003_D12", "AssetItemNumber",
				revaluationTestData.get("AssetItemNumber"));
    }
