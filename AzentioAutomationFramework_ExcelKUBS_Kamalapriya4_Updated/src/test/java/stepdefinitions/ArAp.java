...
public class ArAp {
	...
	//-----------------TC_007 Verify Approved GRN Reference is available on Fixed Asset creation-------
	  @Then("^Click on Report buttonT$")
	    public void click_on_repoet_buttonT() throws Throwable {
	    ...
	    public void click_on_balance_sheet_report_edit_buttonT() throws Throwable {
	    ...
	    public void fill_branch_details_for_reportT() throws Throwable {
	    ...
	    public void select_date_in_calendarT() throws Throwable {
	...
	//------------------@KUBS_AR/AP_UAT_002_004	@TC_01 Create Advance against PO------------------------
	    ...
	    public void click_on_account_recivable_buttonT() throws Throwable {
	    ...
	    public void click_on_account_recivable_advances_eye_buttonT() throws Throwable {
	    ...
	    public void click_to_add_record_in_account_recivableT() throws Throwable {
	    ...
	    public void click_on_save_button_to_save_the_record_for_account_recivableT() throws Throwable {
