...
public class AR_AP_Module extends BaseClass {
	...
	ExcelData exceldata = new ExcelData("C:\\Users\\inindc00072\\git\\AzentioAutomationFramework_KUBS\\AzentioAutomationFramework\\Test-data\\KUBSTestData_ARAP1.xlsx", "ARAP_Module", "DataSet ID") ;
...
while(true)
    ...
    public void select_branch_code_as_azentio_manin_branch() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElement(driver, 2000, enquiryObj.inventoryBranchCode());
		seleniumactions.getClickAndActionsHelper().clickOnElement(enquiryObj.inventoryBranchCode());
		enquiryObj.inventoryBranchCode().sendKeys(testData.get("BranchCode"));
		enquiryObj.inventoryBranchCode().sendKeys(Keys.ENTER);
    }
    ...
    public void choose_the_transaction_from_date() throws Throwable {
		...
		driver.findElement(By.xpath("(//span[@class='owl-dt-control-content owl-dt-control-button-content'])[2]"))
				.click();
		driver.findElement(By.xpath("//span[text()='" + testData.get("GlYear")  + "']")).click();
		driver.findElement(By.xpath("//span[text()='" + testData.get("GlMonth") + "']")).click();
		seleniumactions.getWaitHelper().waitForElement(driver, 2000,
			    driver.findElement(By.xpath("//td[@aria-label='"+testData.get("GlFullMonth")+" "
				+testData.get("GlDay")+", "+testData.get("GlYear")+"']")));
				driver.findElement(By.xpath("//td[@aria-label='"+testData.get("GlFullMonth")+" "
				+testData.get("GlDay")+", "+testData.get("GlYear")+"']")).click();
    }
    ...
    public void choose_the_transaction_to_date_and_click_view_option() throws Throwable {
		...
		driver.findElement(By.xpath("(//span[@class='owl-dt-control-content owl-dt-control-button-content'])[2]"))
				.click();
		driver.findElement(By.xpath("//span[text()='" + testData.get("GlToYear") + "']")).click();
		driver.findElement(By.xpath("//span[text()='" + testData.get("GlMonth")+ "']")).click();
		seleniumactions.getWaitHelper().waitForElement(driver, 2000,
			    driver.findElement(By.xpath("//td[@aria-label='"+testData.get("GlFullToMonth")+" "
		+cancellationofcontractdata.GlToDate+", "+testData.get("GlToYear")+"']")));
				driver.findElement(By.xpath("//td[@aria-label='"+testData.get("GlFullToMonth")+" "
		+testData.get("GlToDate")+", "+testData.get("GlToYear")+"']")).click();
		seleniumactions.getWaitHelper().waitForElement(driver, 2000, enquiryObj.inventoryViewButton());
		seleniumactions.getClickAndActionsHelper().clickOnElement(enquiryObj.inventoryViewButton());
		Thread.sleep(2000); 
    }
...
//****************************************** @KUBS_AR/AP_UAT_004_001TC_01************************************
	...
	@And("^Updating Testdata Id for verify active bill is available for payment settlement$")
    public void updating_testdata_id_for_verify_active_bill_is_available_for_payment_settlement()  {
		testData=exceldata.getTestdata("KUBS_AR/AP_UAT_004_001TC_01_D1");
	...
	public void search_invoice_status_as_active() throws Throwable {
		...
		invoiceBookingObj.searchInvoiceStatus().sendKeys(testData.get("InvoiceStatus"));
   ...
   //**********************************@KUBS_AR/AP_UAT_004_001TC_02************************************************
	...
	@And("^Updating Testdata Id for verify tds% and amount in payment settlement$")
    public void Updating_Testdata_Id_for_verify_tds_and_amount_in_payment_settlement ()  {
		testData=exceldata.getTestdata("KUBS_AR/AP_UAT_004_002TC_01_D1");
...
//*************************************@KUBS_AR/AP_UAT_004_001TC_03***********************************************
	@And("^Updating Testdata Id for vverify net payable amount is correctly calculated for the bill$")
    public void Updating_Testdata_Id_for_verify_net_payable_amount_is_correctly_calculated_for_the_bill ()  {
		testData=exceldata.getTestdata("KUBS_AR/AP_UAT_004_001TC_03_D1");
...
//*************************************@KUBS_AR/AP_UAT_004_001TC_04*************************************
	...
	@And("^Updating Testdata Id for pop up message displayed and click yes to proceed for payment$")
    public void updating_testdata_id_for_pop_up_message_displayed_and_click_yes_to_proceed_for_payment1()  {
		testData=exceldata.getTestdata("KUBS_AR/AP_UAT_004_001TC_04_D1");
	...
	public void enter_the_description() throws Throwable {
		...
		paymentSettlementObj.getDescription().sendKeys(testData.get("PaymentSettlementDescription"));
...
//*************************** @KUBS_AR/AP_UAT_004_001TC_05***************************
	...
	@And("^Updating Testdata Id for verify pop up messages displayed and click no to  return payment settlement$")
    public void updating_testdata_id_for_pop_up_message_displayed_and_click_no_to_return_payment_settlements()  {
		testData=exceldata.getTestdata("KUBS_AR/AP_UAT_004_001TC_05_D1");
	}
	...
	@And("^Updating Testdata Id for verify accounting entries post payment settlement approval$")
    public void updating_testdata_id_for_verify_accounting_entries_post_payment_settlement_approval()  {
		testData=exceldata.getTestdata("KUBS_AR/AP_UAT_004_001TC_06_D1");
	}
    ...
    public void user_search_active_in_payment_settlement_list_view() throws Throwable {
        ...
        paymentSettlementObj.getTransactionStatus().sendKeys(testData.get("ContractStatus"));
    ...
    @And("^Updating Testdata Id for Verify Accounts Payable Report post payment settlement approval$")
    public void updating_testdata_id_for_verify_Accounts_Payable_Report_post_payment_settlement_approval()  {
		testData=exceldata.getTestdata("KUBS_AR/AP_UAT_004_001TC_08_D1");
	}
...
// Verify Balance sheet post Bill is cancelled
	    ...
	    @And("^Updating Testdata Id for  Verify Balance sheet post payment settlement approval$")
	    public void updating_testdata_id_for_Verify_Balance_sheet_post_payment_settlement_approval ()  {
			testData=exceldata.getTestdata("KUBS_AR/AP_UAT_004_001Tc_07_D1");
	    ...
	    public void select_the_reference_number_based_on_we_got_from_appropriation_reversal() throws Throwable {
	        ...
	        account_Receivable.enterAppropriationAmount().sendKeys(testData.get("AppropriationAmount"));
	    }
