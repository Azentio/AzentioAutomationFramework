...
public class ArAp_Enquiry extends BaseClass {
	...
	ExcelData exceldata = new ExcelData("C:\\Users\\inindc00072\\git\\AzentioAutomationFramework_KUBS\\AzentioAutomationFramework\\Test-data\\KUBSTestData_ARAP1.xlsx", "ARAP_Enquiry", "DataSet ID") ;
    ...
    public void select_transaction_from_date_bounced_cheques()  {
		...
		try
		{
			...
			waithelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'"+testData.get("GLMonth")+" "+testData.get("GLYear")+"')]")));
			WebElement monthAndYear=driver.findElement(By.xpath("//span[contains(text(),'"+testData.get("GLMonth")+" "+testData.get("GLYear")+"')]"));
		    break;
		}
		...
		WebElement FinalDay=driver.findElement(By.xpath("//td[@aria-label='"+testData.get("GLFullMonth")+" "+testData.get("GLDay")+", "+testData.get("GLYear")+"']/span"));
    ...
    public void select_transaction_to_date_bounced_cheques() throws InterruptedException  {
		...
		try
		{
			...
			waithelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'"+testData.get("GLToMonth")+" "+testData.get("GLYear")+"')]")));
			WebElement monthAndYear=driver.findElement(By.xpath("//span[contains(text(),'"+testData.get("GLToMonth")+" "+testData.get("GLYear")+"')]"));
		    break;
		}
		...
		WebElement FinalDay2=driver.findElement(By.xpath("//td[@aria-label='"+testData.get("GLFullToMonth")+" "+testData.get("GLToDate")+", "+testData.get("GLYear")+"']/span"));
    ...
    public void validate_bounced_cheques_vourcher_number() throws InterruptedException  {
    	...
    	javascripthelper.scrollIntoView(arAp_EnquiryObj.arAp_Enquiry_Total());
    		...
    		try
    		{
    			...
    			waithelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'"+testData.get("BouncedVoucher")+"')]")));
    			WebElement VoucherNum =driver.findElement(By.xpath("//span[contains(text(),'"+testData.get("BouncedVoucher")+"')]"));
    			break;
    		}
...
//-------------------KUBS_AR/AP_UAT_010_004_TC_02-------------------//
  ...
  //-------------------KUBS_AR/AP_UAT_004_002_TC_02-------------------//
    ...
    public void fill_the_branch_detail() {
    	arAp_EnquiryObj.arAp_Enquiry_BranchCode().sendKeys(testData.get("BranchCode"));
    	arAp_EnquiryObj.arAp_Enquiry_BranchCode().sendKeys(Keys.ENTER);   
    }
...
WebElement VoucherNum =driver.findElement(By.xpath("//span[contains(text(),'"+testData.get("Voucher")+"')]"));
    			...
    			driver.findElement(By.xpath("//span[contains(text(),'"+testData.get("Voucher")+"')]")).isDisplayed();
    			break;
    		}
