...
public class ACCOUNTSPAYABLE_PaymentSettlement extends BaseClass {
	...
	ExcelData exceldata = new ExcelData("C:\\Users\\inindc00072\\git\\AzentioAutomationFramework_KUBS\\AzentioAutomationFramework\\Test-data\\KUBSTestData_ARAP1.xlsx", "ARAP_PaymentSettlement", "DataSet ID") ;
...
paymentSettlementObj.accountsPayableDescription().sendKeys("Ok");
	...
	public void fill_the_mendatory_fields_for_creating_advance_to_employee() throws Throwable {
		...
		accuountsReceivableObj.accountsReceivableAmmount().sendKeys(testData.get("Ammount"));
