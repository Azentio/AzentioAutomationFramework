...
public class ARAP_AccountsReceivable_AccountsPayable extends BaseClass {
	...
	ExcelData exceldata = new ExcelData("C:\\Users\\inindc00072\\git\\AzentioAutomationFramework_KUBS\\AzentioAutomationFramework\\Test-data\\KUBSTestData_ARAP1.xlsx", "ARAP_AccountReceivable_AP", "DataSet ID") ;
    ...
    public void updating_testdata_id_for_cancelled_advances ()  {
		testData=exceldata.getTestdata("KUBS_AR_AP_UAT_003_009_TC_02_D1");
		
    }
	
	@And("^Updating Testdata Id for cancelling Against PO$")
    public void updating_testdata_id_for_cancelling_Against_PO ()  {
		testData=exceldata.getTestdata("KUBS_AR_AP_UAT_003_009_TC_03_D1");
...
//		waitHelper.waitForElement(driver, 5000, arapObj.ARAP_GetcancelBpName());
    ...
    public void verify_accounting_entries_post_bill_is_approved_is_display() throws Throwable {
		...
		for (int i = 0; i <= 299; i++) {
			try {
				...
				driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),'" + arapData.InvoiceImburse + "')])[1]"))
						.isDisplayed();

				driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),'" + arapData.InvoiceImburse + "')])[1]"));
				String TransactionType = driver
						.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),' " + arapData.InvoiceImburse
								+ " ')]/ancestor::datatable-body-cell[1]/following-sibling::datatable-body-cell[5]//span)[1]"))
						.getText();
				System.out.println("TransactionType is " + TransactionType);
				String amount = driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),' "
		...
		for (int i = 0; i <= 299; i++) {
			try {
				...
				driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),'" + arapData.InvoiceImburse + "')])[2]"))
						.isDisplayed();
	...
	public void give_current_business_date_in_arap() throws Throwable {
		...
		while (true) {
			try {
				...
				waitHelper.waitForElement(driver, 3000, driver.findElement(
						By.xpath("//span[contains(text(),'" + testData.get("GlToMonth") + " " + arapData.Year + "')]")));
				driver.findElement(
						By.xpath("//span[contains(text(),'" + testData.get("GlToMonth") + " " + arapData.Year + "')]"));
				break;
			}
		...
		waitHelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//td[@aria-label='"
				+ arapData.GlFullToMonth + " " + testData.get("GlToDate") + ", " + arapData.Year + "']/span")));
		WebElement Click = driver.findElement(By.xpath("//td[@aria-label='" + arapData.GlFullToMonth + " "
				+ testData.get("GlToDate") + ", " + arapData.Year + "']/span"));
	...
	public void select_from_date_in_calender() throws Throwable {
		...
		driver.findElement(By.xpath("(//span[@class='owl-dt-control-content owl-dt-control-button-content'])[2]"))
				.click();
		driver.findElement(By.xpath("//span[text()='" + testData.get("Year1") + "']")).click();
		...
		clickAndActionHelper.doubleClick(driver.findElement(By.xpath(("(//span[text()='" + testData.get("Day") + "'])[1]"))));
	}
	...
	public void select_to_date_in_calender() throws Throwable {
		while (true) {
			try {
				...
				waitHelper.waitForElement(driver, 3000, driver.findElement(
						By.xpath("//span[contains(text(),'" + testData.get("GlToMonth") + " " + testData.get("GlYear") + "')]")));
				driver.findElement(
						By.xpath("//span[contains(text(),'" + testData.get("GlToMonth") + " " + testData.get("GlYear") + "')]"));
				break;
			}
		...
		WebElement FinalDay = driver.findElement(By.xpath("//td[@aria-label='" + arapData.GlFullToMonth + " "
				+ testData.get("GlToDate") + ", " + testData.get("GlYear") + "']/span"));
	...
	public void give_the_business_partner() throws Throwable {
		...
		arapObj.adjustmentBpName().sendKeys(testData.get("BPNumber"));
	...
	public void enter_business_partner() throws Throwable {
		...
		arapObj.accountsPayablePayementSettlementBpName().sendKeys(testData.get("BusinesPartner"));
	...
	public void choose_value_date_as_system_current_date() throws Throwable {
		...
		while (true) {
			try {
				...
				waitHelper.waitForElement(driver, 5000, driver.findElement(
						By.xpath("//span[contains(text(),'" + testData.get("GlMonth ")+ " " + testData.get("GlYear")+ "')]")));
				driver.findElement(
						By.xpath("//span[contains(text(),'" + testData.get("GlMonth") + " " + testData.get("GlYear") + "')]"));
				break;
			}
		...
		waitHelper.waitForElement(driver, 5000, driver.findElement(By.xpath("//td[@aria-label='" + testData.get("GlMonth ")
				+ " " + testData.get("GlDay") + ", " + testData.get("GlYear") + "']/span")));
		WebElement Click = driver.findElement(By.xpath("//td[@aria-label='" + testData.get("GlMonth ") + " "
				+ testData.get("GlDay") + ", " + testData.get("GlYear") + "']/span"));
	...
	public void give_business_partner_name() throws Throwable {
		// ----------ENTER BUSINESS PARTNER-------//
		waitHelper.waitForElement(driver, 2000, arapObj.accountsPayablePayementSettlementBpName());
		arapObj.accountsPayablePayementSettlementBpName().sendKeys(testData.get("BPNumber"));
		arapObj.accountsPayablePayementSettlementBpName().sendKeys(Keys.ENTER);
	}
...
//		arapObj.ARAP_Debit_Cost().sendKeys(Keys.ENTER);
	...
	public void enter_cancelled_value_in_advance_status() throws Throwable {
		...
		arapObj.accountsReceivable_Advance_ReceivableName().sendKeys(testData.get("RecivableName"));
		...
		arapObj.accountsReceivable_Advance_ADVstatus().sendKeys(testData.get("GRNStatus1"));
	}
...
//		waitHelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//span[contains(text(),'" + readerData.readReferancedata()	+ "')]/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell/div/ion-buttons/ion-button")));
	...
	public void give_the_adjustment_item_type_as_ar_advance() throws Throwable {
		...
		waitHelper.waitForElement(driver, 2000, arapObj.adjustmentItemType());
		arapObj.adjustmentItemType().click();
		arapObj.adjustmentItemType().sendKeys(testData.get("AdvanceType"));
		arapObj.adjustmentItemType().sendKeys(Keys.ENTER);
	}
	...
	public void give_the_advance_adjustment_ref_no_and_validate() throws Throwable {
		// -----------ADJUSTMENTS REF NO VALIDATE--------------//
		waitHelper.waitForElement(driver, 2000, arapObj.adjustmentAdjustmentReference());
		arapObj.adjustmentAdjustmentReference().sendKeys(testData.get("ADVNumber"));
    ...
    public void verify_accounting_entries_advance_to_empolyee_post_payment_settlement_cancellation() throws Throwable {
		...
		for (int i = 0; i <= 299; i++) {
			try {
				...
				driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),'" + arapData.TxnNo + "')])[1]"))
						.isDisplayed();
				...
				String TransactionType = driver
						...
						.getText();
				System.out.println("TransactionType is " + TransactionType);
				String amount = driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),' " + arapData.TxnNo
						+ " ')]/ancestor::datatable-body-cell[1]/following-sibling::datatable-body-cell[6]//span)[1]"))
						.getText();
				System.out.println("Amount is " + amount);
				break;
		...
		for (int i = 0; i <= 299; i++) {
			try {
				...
				driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),'" + arapData.TxnNo + "')])[2]"))
						.isDisplayed();
