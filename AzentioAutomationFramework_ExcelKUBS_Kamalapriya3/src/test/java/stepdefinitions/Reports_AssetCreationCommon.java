...
public class Reports_AssetCreationCommon {
	...
	ExcelData LimitConfig = new ExcelData(excelPath, "LimitConfigCataTestData", "DataSet ID");
...
//			}catch(NoSuchElementException nosuchElement)
//			{
//				wait.waitForElement(driver, 3000, bUSINESS_PARTNER_SETUP_BusinessPartnerObj.businessPartner_SelectDate());
