...
//
//				waitHelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'"
//						+ assetAmmendmentTestData.get("GlMonth") + " " + assetAmmendmentTestData.get("GlYear") + "')]")));
...
//			}
//		}
//		WebElement FinalDay = driver.findElement(By.xpath("//td[@aria-label='" + assetAmmendmentTestData.get("GlFullMonth") + " "
//				+ assetAmmendmentTestData.get("GlDay") + ", " + assetAmmendmentTestData.get("GlYear") + "']/span"));
	...
	public void choose_calender_to_date() throws Throwable {
		...
		while (true) {
			try {
				...
				waitHelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'"
						+ assetAmmendmentTestData.get("GlToMonth") + " " + assetAmmendmentTestData.get("GlYear") + "')]")));
				WebElement monthAndYear = driver.findElement(By.xpath("//span[contains(text(),'"
						+ assetAmmendmentTestData.get("GlToMonth") + " " + assetAmmendmentTestData.get("GlYear") + "')]"));
				break;
			}
		...
		WebElement FinalDay = driver.findElement(By.xpath("//td[@aria-label='" + assetAmmendmentTestData.get("GlFullToMonth") + " "
				+ assetAmmendmentTestData.get("GlToDate") + ", " + assetAmmendmentTestData.get("GlYear") + "']/span"));
		clickAndActionHelper.doubleClick(FinalDay);
	}
