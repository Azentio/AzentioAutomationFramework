...
paymentSettlementObj.accountsPayableDescription().sendKeys("Ok");
	...
	public void fill_the_mendatory_fields_for_creating_advance_to_employee() throws Throwable {
		...
		accuountsReceivableObj.accountsReceivablereceivableNameInput()
				.sendKeys(AccoutsReceivableAdvanceTestData.RecevableName);
		Thread.sleep(500);
		accuountsReceivableObj.accountsReceivablereceivableNameInput().sendKeys(Keys.DOWN);
		...
		Thread.sleep(500);
		accuountsReceivableObj.accountsReceivablereceivablebusinessPartnerEmployeeName().sendKeys(Keys.DOWN);
		...
		Thread.sleep(500);
		accuountsReceivableObj.accountsReceivablereceivablePaymentMode().sendKeys(Keys.DOWN);
