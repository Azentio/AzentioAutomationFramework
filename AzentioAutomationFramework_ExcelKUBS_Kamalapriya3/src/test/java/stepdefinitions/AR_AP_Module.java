...
public class AR_AP_Module extends BaseClass {
	...
	ArAp_BalanceSheetReportTestDataType arAp_BalanceSheetReportTestDataType = jsonReader
			.getBalanceSheetReportByName("maker");
	...
	public void user_navigate_to_azentio_url_and_login_as_maker_for_verify_post_bill_is_approved_in_accounting_entries()
			throws Throwable {
	...
	public void click_the_account_payable_main_module_for_verify_post_bill_is_approved_in_accounting_entries()
			throws Throwable {
	...
	public void click_the_eye_icon_of_invoice_bill_booking_for_verify_post_bill_is_approved_in_accounting_entries()
			throws Throwable {
	...
	public void click_the_search_icon_in_list_view_for_verify_post_bill_is_approved_in_accounting_entries()
			throws Throwable {
	...
	public void search_invoice_type_as_expense_for_verify_post_bill_is_approved_in_accounting_entries()
			throws Throwable {
	...
	public void click_the_financial_transaction_edit_icon_for_verify_post_bill_is_approved_in_accounting_entries()
			throws Throwable {
	...
	public void select_the_branch_code_as_azentio_main_branch_for_verify_post_bill_is_approved_in_accounting_entries()
			throws Throwable {
	...
	public void select_the_transaction_from_date_for_verify_post_bill_is_approved_in_accounting_entries()
			throws Throwable {
	...
	public void select_the_transaction_to_date_for_verify_post_bill_is_approved_in_accounting_entries()
			throws Throwable {
	...
	public void verify_that_the_invoice_number_get_from_active_bill_matches_with_voucher_id_in_report()
			throws Throwable {
		int i = 1;
		while (true) {
			try {
				seleniumactions.getWaitHelper().waitForElement(driver, 2000,
						driver.findElement(By.xpath("//datatable-body-cell[1]//span[contains(text(),'"
								+ testdata.get("invoicenumberforactivebill") + "')]")));
				driver.findElement(By.xpath("//datatable-body-cell[1]//span[contains(text(),'"
						+ testdata.get("invoicenumberforactivebill") + "')]")).isDisplayed();
				String invoicenumber = driver.findElement(By.xpath("//datatable-body-cell[1]//span[contains(text(),'"
						+ testdata.get("invoicenumberforactivebill") + "')]")).getText();
	...
	public void get_the_grn_number() throws Throwable {
		javascriphelper.JavaScriptHelper(driver);
		String grnNumber = (String) javascriphelper
				.executeScript("return document.getElementsByName('grnNumber')[1].value");
	...
	public void verify_the_grn_number_in_voucher_id_and_verify_transaction_type() throws Throwable {
		while (true) {
			try {
				seleniumactions.getWaitHelper().waitForElement(driver, 2000, driver.findElement(By.xpath(
						"(//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("grnNumber") + "')])[1]")));
				driver.findElement(By.xpath(
						"(//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("grnNumber") + "')])[1]"))
						.isDisplayed();
				String invoiceNumber = driver
						.findElement(By.xpath(
								"//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("grnNumber") + "')]"))
						.getText();
	...
	public void get_buisness_partner_name_and_bill_status_for_invoice_against_po() throws Throwable {
		...
		String buisnessPartnerName = invoiceBookingObj.getBuisnessPartnerFromBillInvoiceAgainstPo().getText();
		...
		// String
		// xpath="//ion-col[20]/app-kub-lov[1]/span[1]/ng-select[1]/div[1]/div[1]/div[2]";
	...
	public void get_buisness_partner_nameget_contract_end_date_and_get_contract_acccount_codeget_contract_status()
			throws Throwable {
		seleniumactions.getWaitHelper().waitForElement(driver, 2000,
				cancellationofcontract.getBuisnessPartnerNameinContract());
		String buisnessPartnerName = cancellationofcontract.getBuisnessPartnerNameinContract().getText();
		testdata.put("buisnessPartnerName", buisnessPartnerName);
		javascriphelper.JavaScriptHelper(driver);
		String contractacccountcode = (String) javascriphelper
				.executeScript("return document.getElementsByName('contractCode')[1].value");
		...
		String contractStatus = driver
				.findElement(By.xpath("(//ion-col[15]/app-kub-lov[1]/span[1]/ng-select[1]/div[1]/div[1]/div)[2]"))
				.getText();
	...
	public void select_the_date_based_on_contract_end_date() throws Throwable {
		...
		seleniumactions.getWaitHelper().waitForElement(driver, 2000, driver.findElement(By.xpath("//td[@aria-label='"
				+ testdata.get("fullmonth") + " " + testdata.get("day") + ", " + testdata.get("year") + "']")));
		driver.findElement(By.xpath("//td[@aria-label='" + testdata.get("fullmonth") + " " + testdata.get("day") + ", "
				+ testdata.get("year") + "']")).click();
	}
	...
	public void verify_the_contract_code_in_contract_report() throws Throwable {
		...
		// seleniumactions.getBrowserHelper().getWindowHandles();
		seleniumactions.getBrowserHelper().SwitchToWindow(1);
...
//************************************* @KUBS_AR/AP_UAT_003_001TC_02****************************************************
	...
	public void get_buisness_partner_name_and_get_contract_name() throws Throwable {
		...
		javascriphelper.JavaScriptHelper(driver);
		String contractname = (String) javascriphelper
				.executeScript("return document.getElementsByName('contractName')[1].value");
	...
	public void search_PO_status_as_Active() throws Throwable {
		// seleniumactions.getWaitHelper().waitForElement(driver, 2000,
		// cancellationofcontract.getPostatus());
		javascriphelper.JavaScriptHelper(driver);
		...
		cancellationofcontract.getSearchVendorPoStatus().sendKeys(cancellationofcontractdata.contractstatusactive);
	}
...
// accounting entries for cancelled bill
	...
	public void verify_that_the_invoice_number_get_from_bill_matches_with_voucher_id_in_report() throws Throwable {
		while (true) {
			try {
				seleniumactions.getWaitHelper().waitForElement(driver, 2000, driver.findElement(By.xpath(
						"//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("invoicenumber") + "')]")));
				driver.findElement(By.xpath(
						"//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("invoicenumber") + "')]"))
						.isDisplayed();
				String invoiceNumber = driver.findElement(By.xpath(
						"//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("invoicenumber") + "')]"))
						.getText();
				System.out.println(invoiceNumber);
				break;
	...
	public void select_the_date() throws Throwable {
		...
		while (true) {
			try {
				...
				waithelper.waitForElement(driver, 2000,
						driver.findElement(
								By.xpath("//span[contains(text(),'" + arAp_BalanceSheetReportTestDataType.Month + " "
										+ arAp_BalanceSheetReportTestDataType.Year + "')]")));
				WebElement monthAndYear = driver
						.findElement(By.xpath("//span[contains(text(),'" + arAp_BalanceSheetReportTestDataType.Month
								+ " " + arAp_BalanceSheetReportTestDataType.Year + "')]"));
				Thread.sleep(2000);
				break;
			}
		...
		WebElement FinalDay = driver.findElement(By.xpath("//td[@aria-label='"
				+ arAp_BalanceSheetReportTestDataType.FullMonth + " " + arAp_BalanceSheetReportTestDataType.Day + ", "
				+ arAp_BalanceSheetReportTestDataType.Year + "']/span"));
	...
	public void verify_the_credit_note_number_in_voucher_id_and_verify_transaction_type() throws Throwable {
		while (true) {
			try {
				seleniumactions.getWaitHelper().waitForElement(driver, 2000,
						driver.findElement(By.xpath("//datatable-body-cell[1]//span[contains(text(),'"
								+ testdata.get("creditnotenumber") + "')]")));
				driver.findElement(By.xpath(
						"//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("creditnotenumber") + "')]"))
						.isDisplayed();
				String creditnotenumber = driver.findElement(By.xpath(
						"//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("creditnotenumber") + "')]"))
						.getText();
	...
	public void get_buisness_partner_name_get_credit_note_number_and_get_credit_note_date() throws Throwable {
		...
		String creditnotenumber = (String) javascriphelper
				.executeScript("return document.getElementsByName('creditnoteNo')[1].value");
		testdata.put("creditnotenumber", creditnotenumber);
		System.out.println(creditnotenumber);
	...
	public void verify_the_credit_note_cancelled_is_available_in_the_report() throws Throwable {
		...
		while (true) {
			try {
				javascriphelper.JavaScriptHelper(driver);
				javascriphelper.scrollIntoView(
						driver.findElement(By.xpath("//div[text()='" + testdata.get("creditnotenumber") + "']")));
				...
				String creditnumber = driver
						.findElement(By.xpath("//div[text()='" + testdata.get("creditnotenumber") + "']")).getText();
...
//****************************************** @KUBS_AR/AP_UAT_004_001TC_01************************************
	...
	public void verify_that_active_bill_is_available_for_payment_settlement() throws Throwable {
		...
		// Assert.assertEquals(testdata.get("buisnesspartner"),
		// ActiveBillBuisnessPartner);
...
//*************************** @KUBS_AR/AP_UAT_004_001TC_05***************************
	...
	public void get_the_transaction_number_from_payment_settlement() throws Throwable {
		javascriphelper.JavaScriptHelper(driver);
		String txtnumber = (String) javascriphelper
				.executeScript("return document.getElementsByName('paymentNo')[1].value");
	...
	public void verify_the_transaction_number_in_voucher_id_and_verify_payment_approval() throws Throwable {
		while (true) {
			try {
				seleniumactions.getWaitHelper().waitForElement(driver, 2000, driver.findElement(By.xpath(
						"//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("txtnumber") + "')]")));
				driver.findElement(By
						.xpath("//datatable-body-cell[1]//span[contains(text(),'" + testdata.get("txtnumber") + "')]"))
						.isDisplayed();
	...
	public void get_buisness_partner_name_and_payment_settlement_date() throws Throwable {
		...
		testdata.put("buisnessPartnerName", buisnessPartnerName);
		javascriphelper.JavaScriptHelper(driver);
		String paymentDate = (String) javascriphelper
				.executeScript("return document.getElementsByName('kubDateTime')[1].value");
	...
	public void verify_the_invoice_number_get_from_payment_settlement_available_in_account_payable_report()
			throws Throwable {
...
//*************************************** @KUBS_AR/AP_UAT_004_004TC_01***************************************************************
	...
	public void get_buisness_partner_name_and_invoice_number() throws Throwable {
		for (int i = 0; i <= 50; i++) {
			try {
				seleniumactions.getWaitHelper().waitForElement(driver, 2000,
						account_Receivable.debitNoteBuisnessPartner());
				break;
			} catch (Exception e) {
				if (i == 50) {
					Assert.fail(e.getMessage());
		...
		System.out.println("Debit Invoice number :"+text);
	...
	public void search_the_invoice_number_based_on_invoice_after_click_bill_and_get_grossdebit_amount()
		...
		for (int j = 1; j <= 12; j++) {
			...
			for (int i = 1; i <= 6; i++) {
				...
				// "]/datatable-body-row/div/datatable-body-cell[4]/div)[2]")));
...
//****************************@KUBS_AR/AP_UAT_004_004TC_02****************************************
	...
	public void user_search_transaction_number_which_is_debit_payment_in_payment_settlement_list_view()
			throws Throwable {
	...
	public void get_the_debit_note_number_and_buisnes_partner_namedebit_note_date() throws Throwable {
		...
		javascriphelper.JavaScriptHelper(driver);
		String debitNotenumber = (String) javascriphelper
		...
		String DebitnoteDate = (String) javascriphelper
				.executeScript("return document.getElementsByName('kubDateTime')[0].value");
...
// Verify Balance sheet post Bill is cancelled
	...
	public void click_the_appropriation_reversal_eye_icon() throws Throwable {
		...
		seleniumactions.getWaitHelper().waitForElement(driver, 2000,
				account_Receivable.appropriationReversalsEyeIcon());
	...
	public void verify_receipts_and_receivable_against_cancelled_appropriation_must_be_available_again_for_receipt_appropriation()
			throws Throwable {
		System.out.println(
				"Verfied Receipts and receivable against cancelled appropriation available again for receipt appropriation");
	}
