...
public class KUBS_ChekcerSteps extends BaseClass {
    ...
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_replacement_record_as_a_checker_for_deallocation() throws Throwable {
    	driver.get(configFileReader.getApplicationUrl());
		kubsLogin.loginToAzentioAppAsChecker("Checker");
		checkerTestData = excelDataForAssetReplacement.getTestdata("KUBS_FAT_UAT_006_AR_D10");
    }
    ...
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_ammendment_record_as_a_checker_for_deallocation() throws Throwable {
		driver.get(configFileReader.getApplicationUrl());
		kubsLogin.loginToAzentioAppAsChecker("Checker");
		checkerTestData = excelDataForAssetAmmendment.getTestdata("KUBS_FAT_UAT_006_011_AA_D11");
		}
    ...
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_revaluation_record_in_checker_which_is_already_done_on_asset_replacement() throws Throwable {
	 ...
	 @Given("^navigate to kubs url to approve the fixed asset revaluation record in checker$")
	    public void navigate_to_kubs_url_to_approve_the_fixed_asset_revaluation_record_in_checker() throws Throwable {
		 driver.get(configFileReader.getApplicationUrl());
			kubsLogin.loginToAzentioAppAsChecker("Checker");
			checkerTestData = excelDataForAssetRevaluation.getTestdata("KUBS_FAT_UAT_012_01_DE_D1");
			}
    ...
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_creation_record_with_full_details_in_checker_fo_the_pre_requiste_of_asset_revaluation() throws Throwable {
	 ...
	 @Given("^navigate to kubs url to approve the fixed asset creation record with full details in checker fo the pre requiste of asset sale$")
	    public void navigate_to_kubs_url_to_approve_the_fixed_asset_creation_record_with_full_details_in_checker_fo_the_pre_requiste_of_asset_sale() throws Throwable {
		 driver.get(configFileReader.getApplicationUrl());
			kubsLogin.loginToAzentioAppAsChecker("Checker");
			checkerTestData = excelDataForAssetCreation.getTestdata("KUBS_FAT_UATD_002_007_D11");
	 }
    ...
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_creation_record_with_full_details_as_a_checker_for_asset_allocation() throws Throwable {
	 ...
	 @Given("^navigate to kubs url to approve the fixed asset creation record as a checker for asset allocation prerequest for asset deallocation1$")
	    public void navigate_to_kubs_url_to_approve_the_fixed_asset_creation_record_as_a_checker_for_asset_allocation_prerequest_for_asset_deallocation1() throws Throwable {
			checkerTestData = excelDataForAssetCreation.getTestdata("KUBS_FAT_UAT_002_007_D11");
    ...
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_allocation_from_asset_sale_record_as_a_checker() throws Throwable {
    	driver.get(configFileReader.getApplicationUrl());
		kubsLogin.loginToAzentioAppAsChecker("Checker");
		checkerTestData = excelDataForAssetAllocation.getTestdata("KUBS_FAT_UATD_006_003_D11");
    }
    @Given("^navigate to kubs url to approve the fixed asset allocation from asset revalauation record as a checker$")
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_allocation_from_asset_revalauation_record_as_a_checker() throws Throwable {
    	driver.get(configFileReader.getApplicationUrl());
		kubsLogin.loginToAzentioAppAsChecker("Checker");
		checkerTestData = excelDataForAssetAllocation.getTestdata("KUBS_FAT_UATD_006_003_D12");
		}
    @Given("^navigate to kubs url to approve the fixed asset allocation from asset replacement record as a checker$")
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_allocation_from_asset_replacement_record_as_a_checker() throws Throwable {
    	driver.get(configFileReader.getApplicationUrl());
		kubsLogin.loginToAzentioAppAsChecker("Checker");
		checkerTestData = excelDataForAssetAllocation.getTestdata("KUBS_FAT_UATD_006_011_AR_D14");
    }


    @Given("^navigate to kubs url to approve the fixed asset allocation from asset ammenment record as a checker$")
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_allocation_from_asset_ammenment_record_as_a_checker() throws Throwable {
    	driver.get(configFileReader.getApplicationUrl());
		kubsLogin.loginToAzentioAppAsChecker("Checker");
		checkerTestData = excelDataForAssetAllocation.getTestdata("KUBS_FAT_UATD_006_011_AA_D13");
    }
    @Given("^navigate to kubs url to approve the fixed asset allocation from asset transfer record as a checker$")
    public void navigate_to_kubs_url_to_approve_the_fixed_asset_allocation_from_asset_transfer_record_as_a_checker() throws Throwable {
    	driver.get(configFileReader.getApplicationUrl());
		kubsLogin.loginToAzentioAppAsChecker("Checker");
		checkerTestData = excelDataForAssetAllocation.getTestdata("KUBS_FAT_UATD_006_011_AT_D1");
		}
	...
	public void navigate_to_kubs_url_to_approve_the_fixed_asset_sale_record_whcih_is_sold_at_high_price_as_a_checker()
	 ...
	 @Given("^navigate to kubs url to approve the fixed asset sale record as a checker$")
	    public void navigate_to_kubs_url_to_approve_the_fixed_asset_sale_record_as_a_checker() throws Throwable {
		 driver.get(configFileReader.getApplicationUrl());
			kubsLogin.loginToAzentioAppAsChecker("Checker");
			checkerTestData = excelDataForAssetSale.getTestdata("KUBS_FAT_UATD_004_003_01_D11");
	 }
	...
	public void navigate_to_kubs_url_to_approve_the_fixed_asset_de_allocation_record_as_a_checker() throws Throwable {
	 ...
	 @Given("^navigate to kubs url to approve the asset sale record to de allocation as a checker$")
	    public void navigate_to_kubs_url_to_approve_the_asset_sale_record_to_de_allocation_as_a_checker() throws Throwable {
		 driver.get(configFileReader.getApplicationUrl());
			kubsLogin.loginToAzentioAppAsChecker("Checker");
			checkerTestData = excelDataForAssetDeAllocation.getTestdata("KUBS_FAT_UATD_006_005_01_D11");
		} 
	 @Given("^navigate to kubs url to approve the asset revaluation record to de allocation as a checker$")
	    public void navigate_to_kubs_url_to_approve_the_asset_revaluation_record_to_de_allocation_as_a_checker() throws Throwable {
		 driver.get(configFileReader.getApplicationUrl());
			kubsLogin.loginToAzentioAppAsChecker("Checker");
			checkerTestData = excelDataForAssetDeAllocation.getTestdata("KUBS_FAT_UATD_006_010_D1");
			}
	  @Given("^navigate to kubs url to approve the asset replacement record to de allocation as a checker$")
	    public void navigate_to_kubs_url_to_approve_the_asset_replacement_record_to_de_allocation_as_a_checker() throws Throwable {
		  driver.get(configFileReader.getApplicationUrl());
			kubsLogin.loginToAzentioAppAsChecker("Checker");
			checkerTestData = excelDataForAssetDeAllocation.getTestdata("KUBS_FAT_UATD_006_013_AR_D1");
			}
	 @Given("^navigate to kubs url to approve the asset ammenment record to de allocation as a checker$")
	    public void navigate_to_kubs_url_to_approve_the_asset_ammenment_record_to_de_allocation_as_a_checker() throws Throwable {
		 driver.get(configFileReader.getApplicationUrl());
			kubsLogin.loginToAzentioAppAsChecker("Checker");
			checkerTestData = excelDataForAssetDeAllocation.getTestdata("KUBS_FAT_UATD_006_013_D1");
			}

	    @Given("^navigate to kubs url to approve the asset transfer record to de allocation as a checker$")
	    public void navigate_to_kubs_url_to_approve_the_asset_transfer_record_to_de_allocation_as_a_checker() throws Throwable {
	    	 driver.get(configFileReader.getApplicationUrl());
				kubsLogin.loginToAzentioAppAsChecker("Checker");
				checkerTestData = excelDataForAssetDeAllocation.getTestdata("KUBS_FAT_UATD_006_013_AT_D1");
				}	    
	...
	public void click_on_temp_view_near_by_open_pool() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, checkerObj.kubsCheckerOpenPoolTemp(), 30, 1);
