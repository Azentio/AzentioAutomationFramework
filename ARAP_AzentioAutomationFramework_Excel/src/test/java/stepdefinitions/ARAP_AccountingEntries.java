...
public class ARAP_AccountingEntries {
	...
	ExcelData excelData1 = new ExcelData("C:\\Users\\inindc00091\\git\\AzentioAutomationFramework\\ARAP_Excel_priyanka0612\\AzentioAutomationFramework_ARAP_Excel\\Test-data\\KUBS_TESTDATA_V1.xlsx",
...
//				arapObj.ARAPViewButton().click();;
				javaScriptHelper.JSEClick(ViewButton);
//				clickAndActionHelper.doubleClick(ViewButton);
				waitHelper.waitForElementwithFluentwait(driver, arapObj.ARAP_FinancialTransactionReportTitle());
				arapObj.ARAP_FinancialTransactionReportTitle().isDisplayed();
				break;
	...
	public void verify_accounting_entries_post_bill_is_approved() throws Throwable {
		...
		for (int i = 0; i <= 299; i++) {
			try {
				...
				driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),'" + testData.get("InvoiceNoBill") + "')])[1]")).isDisplayed();

				driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),'" + testData.get("InvoiceNoBill") + "')])[1]"));
				String TransactionType = driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),' " + testData.get("InvoiceNoBill")
						+ " ')]/ancestor::datatable-body-cell[1]/following-sibling::datatable-body-cell[5]//span)[1]")).getText();
				System.out.println("TransactionType is " + TransactionType);
				String amount = driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),' " + testData.get("InvoiceNoBill")
						+ " ')]/ancestor::datatable-body-cell[1]/following-sibling::datatable-body-cell[6]//span)[1]")).getText();
		...
		for (int i = 0; i <= 299; i++) {
			try {
				...
				driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),'" + testData.get("InvoiceNoBill") + "')])[2]")).isDisplayed();

				driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),'" + testData.get("InvoiceNoBill") + "')])[1]"));
				String TransactionType = driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),' " + testData.get("InvoiceNoBill")
						+ " ')]/ancestor::datatable-body-cell[1]/following-sibling::datatable-body-cell[5]//span)[2]")).getText();
				System.out.println("TransactionType is " + TransactionType);
				String amount = driver.findElement(By.xpath("(//datatable-body-cell[1]//span[contains(text(),' " + testData.get("InvoiceNoBill")
						+ " ')]/ancestor::datatable-body-cell[1]/following-sibling::datatable-body-cell[6]//span)[2]")).getText();
				System.out.println("Amount is " + amount);
				break;
