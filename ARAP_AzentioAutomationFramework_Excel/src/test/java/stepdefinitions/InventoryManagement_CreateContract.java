...
public class InventoryManagement_CreateContract {
...
//--------	 @KUBS_INV_MGMT_UAT_001_002  ------------
	...
	public void user_should_navigate_to_accounts_payable_menu_to_create_contract() throws InterruptedException {
//		Thread.sleep(2000);
	...
	public void click_on_eye_button_of_vendor_contract_to_create_contract() throws InterruptedException {
	...
	public void click_on_add_button_to_create_contract_to_create_contract() throws InterruptedException {
//		Thread.sleep(1000);
	...
	public void fill_the_required_fields_to_create_vendor_contract() throws InterruptedException {
...
//		Thread.sleep(2000);
		...
		while (true) {
			try {
				...
				waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//span[contains(text(),'" + testData.get("AgreementMonth") + " " + testData.get("AgreementYear") + "')]")));
		...
		for(int i=0;i<=35;i++) {
			try {
				waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//span[text()='" + testData.get("ContractEndMonth") + " " + testData.get("ContractEndYear") + " ']")));
		...
		while (true) {
			try {
				waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//span[contains(text(),'" + testData.get("ContractSignedOnMonth") + " " + testData.get("ContractSignedOnYear") + "')]")));
		...
		waithelper.waitForElementwithFluentwait(driver, aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_Remark());
...
//		Thread.sleep(1000);
	...
	public void save_and_submit_the_creation_of_contract_record() throws InterruptedException, IOException, ParseException {
		for (int i = 1; i <= 35; i++) {
			try {
...
//    	Thread.sleep(2000);
	...
	public void user_should_login_as_a_reviewer_user() throws IOException, ParseException {
	...
	public void click_on_notification_button_in_reviewer_stage() throws InterruptedException {
//		Thread.sleep(1000);
		for (int i = 1; i <= 10; i++) {
			try {
				waithelper.waitForElementwithFluentwait(driver, aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_NotificationButton());
...
//		Thread.sleep(1000);
	...
	public void user_should_login_as_a_checker_user() throws InterruptedException {
		login = new KUBS_Login(driver);
		driver.get(config.getApplicationUrl());
	...
	public void click_on_security_management_in_checker_stage() {
	...
	public void click_on_open_pool_in_checker_stage() {
	...
	public void click_on_claim_button_in_checker_stage() throws IOException, ParseException, InterruptedException {
		String before_xpath = "//span[contains(text(),'";
...
//		Thread.sleep(1000);
	...
	public void checker_should_approved_the_create_contract_record() throws IOException, ParseException, InterruptedException {
//		Thread.sleep(2000);
		for (int i = 1; i <= 35; i++) {
			try {
				waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//span[contains(text(),'" + testData.get("ReferenceID") + "')]")));
