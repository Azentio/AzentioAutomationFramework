...
public class ARAP_ARandAPObj {
	...
	@FindBy(xpath = "//ion-icon[@ng-reflect-name='search']")
	private WebElement ARAP_SearchIcon;

	public WebElement ARAP_SearchIcon() {

		return ARAP_SearchIcon;
	}

	// datatable-header[1]/div[1]/div[2]/datatable-header-cell[4]/div[1]/ion-input[1]/input[1]
	@FindBy(xpath = "//datatable-header[1]/div[1]/div[2]/datatable-header-cell[3]/div[1]/ion-input[1]/input[1]")
	private WebElement ARAP_InvoiceNumber;

	public WebElement ARAP_InvoiceNumber() {

		return ARAP_InvoiceNumber;
	}
	...
	private WebElement ARAP_SegmentButton_ReportIcon;

	public WebElement ARAP_SegmentButton_ReportIcon() {

		return ARAP_SegmentButton_ReportIcon;
	}
	
	@FindBy(xpath = "//ion-label[contains(text(),'Reports')]")
	private WebElement ARAP_Report;

	public WebElement ARAP_Report() {
...
//	@FindBy(xpath = "//*[@id=\"main-content\"]/app-tabs/ion-tabs/div/ion-router-outlet/app-financial-transaction/ion-header/ion-toolbar/ion-buttons/ion-button")
	...
	@FindBy(xpath = "//ion-title[contains(text(),'Financial Transaction Report')]")
	private WebElement ARAP_FinancialTransactionReportTitle;
	
	public WebElement ARAP_FinancialTransactionReportTitle() {
		
		return ARAP_FinancialTransactionReportTitle;
	}
...
//	@FindBy(xpath = "(//datatable-footer[1]/div[1]/datatable-pager[1])[2]")
	...
	@FindBy(xpath = "//ion-label[contains(text(),'Reports')]")
	private WebElement accountsReceivable_DebitNote_ReportModule;

	public WebElement accountsReceivable_DebitNote_ReportModule() {

		return accountsReceivable_DebitNote_ReportModule;
	}
