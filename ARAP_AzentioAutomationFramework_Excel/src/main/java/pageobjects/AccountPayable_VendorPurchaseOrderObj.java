...
//		@FindBy(xpath = "//ion-col[14]/app-kub-lov[1]/span[1]/ng-select[1]/div[1]/div[1]/div[2]/input")	
	@FindBy(xpath = "//label[contains(text(),'  Cost Center  ')]/../..//div[2]//input[1]")
	...
	private WebElement accountsPayable_VendorPurchaseOrder_InboxSearchIcon;

	public WebElement accountsPayable_VendorPurchaseOrder_InboxSearchIcon() {
		return accountsPayable_VendorPurchaseOrder_InboxSearchIcon;
	}

	// Inbox EventCodeSearch
	@FindBy(xpath = "//div[2]/datatable-header-cell[3]/div[1]/ion-input[1]/input[1]")
	private WebElement accountsPayable_VendorPurchaseOrder_EventCodeSearch;

	public WebElement accountsPayable_VendorPurchaseOrder_EventCodeSearch() {
		return accountsPayable_VendorPurchaseOrder_EventCodeSearch;
	}
	...
	private WebElement accountPayable_VendorPurchaseOrder_Search;

	public WebElement accountPayable_VendorPurchaseOrder_Search() {
		return accountPayable_VendorPurchaseOrder_Search;
	}

	// Record Search using Business Partner
	@FindBy(xpath = "//datatable-header-cell[7]/div/ion-input/input")
	private WebElement accountPayable_VendorPurchaseOrder_BusinessPartnerSearch;

	public WebElement accountPayable_VendorPurchaseOrder_BusinessPartnerSearch() {
		return accountPayable_VendorPurchaseOrder_BusinessPartnerSearch;
	}

	// GRN Status
	@FindBy(xpath = "//datatable-row-wrapper[1]/datatable-body-row/div/datatable-body-cell[14]/div[1]/span")
	private WebElement accountPayable_VendorPurchaseOrder_POStatus;

	public WebElement accountPayable_VendorPurchaseOrder_POStatus() {
		return accountPayable_VendorPurchaseOrder_POStatus;
	}

	// txn Status
	@FindBy(xpath = "//datatable-row-wrapper[1]/datatable-body-row/div/datatable-body-cell[12]/div[1]/span")
	private WebElement accountPayable_VendorPurchaseOrder_TxnStatus;

	public WebElement accountPayable_VendorPurchaseOrder_TxnStatus() {
		return accountPayable_VendorPurchaseOrder_TxnStatus;
	}
