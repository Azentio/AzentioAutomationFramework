...
public class FixedAsset_AssetCreationObj {
	...
	// branch code
		@FindBy(xpath = "//label[contains(text(),'Branch Code')]/../..//div[2]//input[1]")
		...
		// Asset code
		@FindBy(xpath = "//label[contains(text(),'Asset code')]/../..//div[2]//input[1]")
		...
		// HSN Code
		@FindBy(xpath = "//label[contains(text(),'HSN Code')]/../../..//div[2]//input[1]")
