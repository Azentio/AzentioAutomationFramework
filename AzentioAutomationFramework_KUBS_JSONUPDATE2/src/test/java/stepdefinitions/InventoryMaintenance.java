...
//						waithelper.waitForElement(driver,3000,kubschecker.checkerNotificationIcon());
					...
					for (int i = 1; i <= 35; i++) {
						...
						driver.findElement(By.xpath(before_xpath +reader.readReferancedata() +after_xpath)).click();
//				    	waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//datatable-row-wrapper[1]/datatable-body-row/div[2]/datatable-body-cell/div/ion-buttons/ion-button/ion-icon")));
//						WebElement element = driver.findElement(By.xpath("//datatable-row-wrapper[1]/datatable-body-row/div[2]/datatable-body-cell/div/ion-buttons/ion-button/ion-icon"));			
//						clicksAndActionHelper.JSEClick(element);
						//Approve
