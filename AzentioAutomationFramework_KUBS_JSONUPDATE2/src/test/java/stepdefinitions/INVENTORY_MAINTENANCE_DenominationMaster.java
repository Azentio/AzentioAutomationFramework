...
//				+ "')]/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell/div/ion-buttons/ion-button")));
		waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//span[text()='"
				+ jsonWriter.readReferancedata()
				+ "']/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell/div/ion-buttons/ion-button")));
		driver.findElement(By.xpath("//span[text()='" + jsonWriter.readReferancedata()
				+ "']/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell/div/ion-buttons/ion-button"))
				.click();
