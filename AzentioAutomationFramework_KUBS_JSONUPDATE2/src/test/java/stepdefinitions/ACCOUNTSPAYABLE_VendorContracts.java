...
//		waithelper.waitForElement(driver, 2000, aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_AddButton());
	...
	public void fill_the_required_fields_to_create_contract() throws InterruptedException  {
		...
		aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_BP_Name().click();
...
//		Thread.sleep(1000);
		...
		while (true) {
			try {
				...
				waithelper.waitForElementwithFluentwait(driver, driver.findElement(
						By.xpath("//span[contains(text(),'" + aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementMonth + " " + aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementYear + "')]")));
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver, driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementFullMonth +" "+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementYear+"']/span")),5,2);
		...
		clicksAndActionHelper.JSEClick(FinalDay);
...
//		waithelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndFullMonth +" "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndYear+"']/span")));
		waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndFullMonth +" "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndYear+"']/span")));
		...
		clicksAndActionHelper.JSEClick(EndDay);
...
//		aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_ContractSignedOnDate().click();
		clicksAndActionHelper.JSEClick(aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_ContractSignedOnDate());
		while(true)
        {
		try
		{
...
//			waithelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'"+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnMonth+" "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnYear+"')]")));
		...
		waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnFullMonth +" "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnYear+"']/span")));
...
//		waithelper.waitForElementwithFluentwait(driver, kubschecker.checkerRemarks());
		waithelper.waitForElementToVisibleWithFluentWait(driver, kubschecker.checkerRemarks(), 2, 1);
