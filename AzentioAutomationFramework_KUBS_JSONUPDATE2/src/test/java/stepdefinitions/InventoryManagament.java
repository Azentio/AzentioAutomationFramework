...
//				waithelper.waitForElement(driver, 3000,driver.findElement(By.xpath("//span[text()='" + reader.readReferancedata() + "']")));
				waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//span[text()='" + reader.readReferancedata() + "']")));
				WebElement referanceID = driver.findElement(By.xpath("//span[text()='" + reader.readReferancedata() + "']"));
				referanceID.click();
				...
				for (int i = 1; i <= 35; i++) {
					try {
						waithelper.waitForElement(driver, 3000, driver.findElement(
							By.xpath("//span[text()='" + reader.readReferancedata() + "']")));
...
// 				waithelper.waitForElement(driver, 3000, inventoryManagamentObj.inventoryReportIcon());
			...
			public void choose_from_date_in_the_calender() throws Throwable {
				...
				while (true) {
					try {
						...
						waithelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'"
								+ inventoryManagementTestDataType.GlMonth + " " + inventoryManagementTestDataType.GlFromYear + "')]")));
				...
				WebElement FinalDay = driver.findElement(By.xpath("//td[@aria-label='" + inventoryManagementTestDataType.GlFullMonth + " "
						+ inventoryManagementTestDataType.GlDay + ", " + inventoryManagementTestDataType.GlFromYear + "']/span"));
				Thread.sleep(1000);
				clicksAndActionHelper.doubleClick(FinalDay);
			...
			public void click_on_view_button_to_see_the_record() throws Throwable {
			 ...
			 @Then("^validate voucher number for stock issue$")
				...
				waithelper.waitForElement(driver, 3000,driver.findElement(By.xpath("//span[contains(text(),'"+inventoryManagementTestDataType.VoucherForStockIssue+"')]")));


				WebElement VoucherNum =driver.findElement(By.xpath("//span[contains(text(),'"+inventoryManagementTestDataType.VoucherForStockIssue+"')]"));
				break;
