...
@KUBS_INV_MGMT_UAT_001_001 @multiauth @PRE
...
And Click on the eye icon of Inventory Request
     ...
     @PurchseReqConf_KUBS_INV_MGMT_UAT_001_002 @PRE
...
@KUBS_INV_MGMT_UAT_002_002
  Scenario: Create denomination details
    ...
    @KUBS_INV_MGMT_UAT_002_003_Item_Code @MultiAuth @FailTC
...
@InventoryStockIssue @KUBS_INV_MGMT_UAT_004_002 @FailTC
...
@KUBS_INV_MGMT_UAT_004_003StockConfirmT @multiauth @Re
