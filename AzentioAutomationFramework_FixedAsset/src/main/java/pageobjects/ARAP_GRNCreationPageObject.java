...
public class ARAP_GRNCreationPageObject {
	WebDriver driver;

	public ARAP_GRNCreationPageObject(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "(//ion-toolbar/ion-buttons[2]/ion-button[1])[2]")
	...
	@FindBy(xpath = "//body[1]/app-root[1]/ion-app[1]/ion-split-pane[1]/ion-router-outlet[1]/app-tabs[1]/ion-tabs[1]/div[1]/ion-router-outlet[1]/page-grn-item-hdr-update[1]/div[1]/ion-header[1]/ion-toolbar[1]/ion-buttons[1]/ion-button[1]")
	private WebElement itemDetails_SaveButton;

	public WebElement ItemDetailsSaveButton() {
		return itemDetails_SaveButton;
	}
	...
	private WebElement PoNoSuchData;

	public WebElement poNoSuctDataFromDropdown() {
		return PoNoSuchData;
	}

	@FindBy(xpath = "//ion-button[@ng-reflect-router-link='/tabs/list/datagrid/48']")
	private WebElement grn_Temp_view;

	public WebElement grnTempView() {
		return grn_Temp_view;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]/datatable-body-row/div/datatable-body-cell[1]//ion-button")
	private WebElement grn_temp_firstRecord;

	public WebElement grnTempViewFirstRecord() {
		return grn_temp_firstRecord;
	}

	@FindBy(xpath = "//app-inbox//datatable-row-wrapper[1]/datatable-body-row/div/datatable-body-cell[2]//span")
	private WebElement grn_first_reference_id;

	public WebElement grnFirstReferenceId() {
		return grn_first_reference_id;

	}

	@FindBy(xpath = "//app-inbox//datatable-row-wrapper[1]/datatable-body-row/div/datatable-body-cell[1]//ion-button")
	private WebElement grn_first_record;

	public WebElement grnFirstRecord() {
		return grn_first_record;

	}

	@FindBy(xpath = "//input[@placeholder='Search GRN Status']")
	private WebElement grnSearch_GRNStatus;

	public WebElement grnSearchGRNStatus() {
		return grnSearch_GRNStatus;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[3]//span")
	private WebElement getApproved_GRNNumber;
