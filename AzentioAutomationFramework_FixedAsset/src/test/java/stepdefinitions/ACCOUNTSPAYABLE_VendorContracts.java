...
//		Thread.sleep(2000);
		...
		.click();
driver.findElement(By.xpath("//span[text()='" + aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementYear  + "']")).click();
driver.findElement(By.xpath("//span[text()='" + aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementMonth + "']")).click();
waithelper.waitForElement(driver, 2000,
			driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementFullMonth+" "
					+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementYear+"']")));
	driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementFullMonth+" "
			+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementYear+"']")).click();
	/*	while(true)
        {
		try
		{
...
//			waithelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'"+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementMonth+" "+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementYear+"')]")));
			waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//span[contains(text(),'"+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementMonth+" "+aCCOUNTSPAYABLE_VendorContractsTestDataType.AgreementYear+"')]")));
...
//		waithelper.waitForElement(driver, 3000, aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_ContractEndDate());
		...
		driver.findElement(By.xpath("(//span[@class='owl-dt-control-content owl-dt-control-button-content'])[2]"))
		.click();
driver.findElement(By.xpath("//span[text()='" + aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndYear  + "']")).click();
driver.findElement(By.xpath("//span[text()='" + aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndMonth + "']")).click();
waithelper.waitForElement(driver, 2000,
			driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndFullMonth+" "
					+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndYear+"']")));
	driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndFullMonth+" "
			+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractEndYear+"']")).click();
		/*
		while(true)
        {
		try
...
//		waithelper.waitForElement(driver, 3000, aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_ContractSignedOnDate());
		...
		driver.findElement(By.xpath("(//span[@class='owl-dt-control-content owl-dt-control-button-content'])[2]"))
		.click();
driver.findElement(By.xpath("//span[text()='" + aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnYear  + "']")).click();
driver.findElement(By.xpath("//span[text()='" + aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnMonth + "']")).click();
waithelper.waitForElement(driver, 2000,
			driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnFullMonth+" "
					+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnYear+"']")));
	driver.findElement(By.xpath("//td[@aria-label='"+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnFullMonth+" "
			+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnDate+", "+aCCOUNTSPAYABLE_VendorContractsTestDataType.ContractSignedOnYear+"']")).click();
		/*
		while(true)
        {
		try
