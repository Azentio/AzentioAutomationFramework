...
//		if(!driver.findElement(By.xpath("//div/div/button")).getText().contains(bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthMonth+" "+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthYear))
//			{
//				while(true)
...
//					WebElement birthYear=driver.findElement(By.xpath("//td[@aria-label='"+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthYear+"']"));
//				    break;
//				}
//				catch(NoSuchElementException nosuchElement)
//				{
...
//				}
//				javascripthelper.JavaScriptHelper(driver);
//				driver.findElement(By.xpath("//td[@aria-label='"+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthYear+"']")).click();
//				waithelper.waitForElement(driver, 2000, driver.findElement(By.xpath("//td[@aria-label='"+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthYear+"']")));
//				driver.findElement(By.xpath("//td[@aria-label='"+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthMonth+"']")).click();
//				WebElement BirthDate=driver.findElement(By.xpath("//td[@aria-label='"+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthFullMonth +" "+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthDate+", "+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthYear+"']/span"));
//				clicksAndActionHelper.doubleClick(BirthDate);
//		}}
//		else {
