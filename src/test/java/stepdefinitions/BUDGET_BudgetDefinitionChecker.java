...
public class BUDGET_BudgetDefinitionChecker extends BaseClass {
	...
	public void clime_the_record() throws IOException, ParseException {
		...
		waitHelper.waitForElement(driver, 3000, checkerObj.checkerAlertClose());
	...
	public void checker_click_on_notification_icon_record_might_be_showed_in_notification_area() throws Throwable {
		 ...
		 */
		Assert.assertTrue(
				driver.findElement(By.xpath(before_xpath + reader.readReferancedata() + after_xpath)).isDisplayed());
	}
	...
	public void click_on_approve_in_checker_stage() {
		...
		waitHelper.waitForElement(driver, 3000, checkerObj.checkerApproveButton());
   ...
   // this step we enter the alert remark for thei step we can enter the possitive remark because This record going to approve
		waitHelper.waitForElement(driver, checkerObj.checkerRemarks(), 3000);
		checkerObj.checkerRemarks().click();
		checkerObj.checkerRemarks().sendKeys(remarks.PossitiveRemarks);
	...
	public void submit_the_record() {
		...
		javascriptHelper.JSEClick(checkerObj.checkersubmitButton());
		waitHelper.waitForElement(driver, 3000, checkerObj.checkerApprovalStatus());
		String checkerApprovalStatus = checkerObj.checkerApprovalStatus().getText();
	...
	public void reject_the_record() {
		...
		waitHelper.waitForElement(driver, 3000, checkerObj.checkerRejectButton());
	...
	public void write_negative_remark_and_submit_it() {
		...
		checkerObj.checkerRemarks().sendKeys(remarks.NegativeRemarks);
