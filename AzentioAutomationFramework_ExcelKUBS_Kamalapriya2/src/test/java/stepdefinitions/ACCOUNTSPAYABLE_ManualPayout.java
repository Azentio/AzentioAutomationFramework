...
public class ACCOUNTSPAYABLE_ManualPayout {
	...
	ACCOUNTSPAYABLE_ManualPayoutTestDataType aCCOUNTSPAYABLE_ManualPayoutTestDataType = jsonReader
			.getManualPayoutdata("Maker");
...
//    }
	...
	public void fill_the_required_fields_for_manual_payout_vendor()
		...
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_EntityBranch()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.EntityBranch);
		...
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_BP_Name()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.BP_Name);
		...
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_BeneficiaryName()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.BeneficiaryName);
		...
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_Currency()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.Currency);
...
//		payment bank
		...
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_PaymentBank()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.PaymentBank);
		...
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_BankAccountNumber()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.BankAccountNumber);
		...
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_PaymentMode()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.PaymentMode);
		...
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_ReferenceNumber()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.ReferenceNumber);

		// cheque number
		waithelper.waitForElement(driver, 2000,
				aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_ChequeNumber());
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_ChequeNumber()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.ChequeNumber);
		...
		aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_Remark()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.Remarks);

		String beforexpath = "//div[contains(text(),'";
		String afterxpath = "')]/../../datatable-body-cell/div/ion-checkbox";
		driver.findElement(
				By.xpath(beforexpath + aCCOUNTSPAYABLE_ManualPayoutTestDataType.PaymentApprovalTxnNumber + afterxpath))
				.click();
	...
	public void save_and_submit_the_manual_payout_record() throws IOException, ParseException, InterruptedException {
		waithelper.waitForElement(driver, 2000,
				aCCOUNTSPAYABLE_ManualPayoutObj.accountPayable_ManualPayout_SaveButton());
...
//				Assert.assertTrue(referanceID.isDisplayed());
		...
		aCCOUNTSPAYABLE_InvoiceBookingObj.accountPayable_InvoiceBooking_RemarksByMaker()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.RemarkByMaker);
...
//	}
	...
	public void checker_should_approved_the_manual_payout_record()
...
//				+ "')]/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell/div/ion-buttons/ion-button")));
		...
		aCCOUNTSPAYABLE_InvoiceBookingObj.accountPayable_InvoiceBooking_ApprovedByReviewerRemark()
				.sendKeys(aCCOUNTSPAYABLE_ManualPayoutTestDataType.ApprovedByChecker);
		...
		while (true) {
			try {
				...
				driver.findElement(By.xpath(
						beforexpath + aCCOUNTSPAYABLE_ManualPayoutTestDataType.CancelledPaymentTxnNumber + afterxpath))
						.isDisplayed();
