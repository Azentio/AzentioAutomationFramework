...
//-------- KUBS_PC_UAT_006 ------------
	...
	public void user_should_navigate_to_petty_cash_menu() throws InterruptedException {
		Thread.sleep(2000);
		// waithelper.waitForElementToVisibleWithFluentWait(driver,
		// ReconciliationObj.PettyCash_Reconciliation_DirctionIcon(), 90, 5);
		ReconciliationObj.PettyCash_Reconciliation_DirctionIcon().click();

		waithelper.waitForElementToVisibleWithFluentWait(driver,
				ReconciliationObj.PettyCash_Reconciliation_PettyCashMenu(), 90, 5);
	...
	public void click_on_eye_button_of_reconciliation() {
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver, ReconciliationObj.PettyCash_Reconciliation_EyeButton(),
				60, 5);
	...
	public void fill_the_required_fields_for_reconciliation() {
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				ReconciliationObj.PettyCash_Reconciliation_PhysicalCashInHand(), 60, 5);
		ReconciliationObj.PettyCash_Reconciliation_PhysicalCashInHand()
				.sendKeys(ReconciliationTestDataType.PhysicalCashInHand);
	...
	public void save_and_submit_the_reconciliation() throws InterruptedException, IOException, ParseException {
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				ReconciliationObj.PettyCash_Reconciliation_SaveButton(), 60, 5);
...
//    	clicksAndActionHelper.moveToElement(recordstatus);
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				ReconciliationObj.PettyCash_Reconciliation_ApprovalRecordStatus(), 60, 5);
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver, kubschecker.checker_alert_close(), 60, 5);
		kubschecker.checker_alert_close().click();

		waithelper.waitForElementToVisibleWithFluentWait(driver,
				aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_NotificationButton(), 60, 5);
		aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_NotificationButton().click();

		waithelper.waitForElementToVisibleWithFluentWait(driver,
				aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_FirstReferenceId(), 60, 5);
...
//				Assert.assertTrue(referanceID.isDisplayed());
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_SubmitButton(), 60, 5);
		aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_SubmitButton().click();

		waithelper.waitForElementToVisibleWithFluentWait(driver,
				aCCOUNTSPAYABLE_InvoiceBookingObj.accountPayable_InvoiceBooking_RemarksByMaker(), 60, 5);
		...
		aCCOUNTSPAYABLE_InvoiceBookingObj.accountPayable_InvoiceBooking_RemarksByMaker()
				.sendKeys(ReconciliationTestDataType.RemarkByMaker);

		waithelper.waitForElementToVisibleWithFluentWait(driver,
				aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_Submit(), 60, 5);
...
//    	clicksAndActionHelper.moveToElement(recordstatus1);
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_RecordStatus(), 60, 5);
	...
	public void click_on_first_eye_button_of_new_record() {
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				ReconciliationObj.PettyCash_Reconciliation_FirstRecordEyeButton(), 60, 5);
...
//	-----------------PETTY CASH REPORTS-------------------//
	...
	public void select_the_date_to_check_the_fund_requisition_details_are_displaying() throws InterruptedException {
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver, ReconciliationObj.Reports_PettyCash_Calendar1(), 60,
				5);
		...
		while (true) {
			try {
				...
				// driver.findElement(By.xpath("//span[contains(text(),'"+PettyCashTestDataType.FundRequisition_Month+"
				// "+PettyCashTestDataType.FundRequisition_Year+"')]")));
				WebElement birthmonthandyear = driver
						.findElement(By.xpath("//span[contains(text(),'" + PettyCashTestDataType.FundRequisition_Month
								+ " " + PettyCashTestDataType.FundRequisition_Year + "')]"));
//				driver.findElement(By.xpath("//div/div/button")).getText().contains(bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthMonth+" "+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthYear);
				...
				// waithelper.waitForElementwithFluentwait(driver,
				// bUSINESS_PARTNER_SETUP_BusinessPartnerObj.businessPartner_SelectDate());
...
//				System.out.println(headyear);
				...
				if (year < y1 && year < y2) {
					while (true) {
						try {
							// waithelper.waitForElementwithFluentwait(driver,
							// driver.findElement(By.xpath("//span[contains(text(),'"+PettyCashTestDataType.FundRequisition_Year+"')]")));
							WebElement Year = driver.findElement(By.xpath(
									"//span[contains(text(),'" + PettyCashTestDataType.FundRequisition_Year + "')]"));
							break;
						} catch (NoSuchElementException nosuchElement1) {
							// waithelper.waitForElementwithFluentwait(driver,
							// bUSINESS_PARTNER_SETUP_BusinessPartnerObj.businessPartner_ClickOnPreviousYear());
					...
					WebElement Year = driver.findElement(
							By.xpath("//span[contains(text(),'" + PettyCashTestDataType.FundRequisition_Year + "')]"));
					Year.click();

					waithelper.waitForElementToVisibleWithFluentWait(driver,
							driver.findElement(
									By.xpath("//td[@aria-label='" + PettyCashTestDataType.FundRequisition_FullMonth
											+ " " + PettyCashTestDataType.FundRequisition_Year + "']")),
							60, 5);
					driver.findElement(By.xpath("//td[@aria-label='" + PettyCashTestDataType.FundRequisition_FullMonth
							+ " " + PettyCashTestDataType.FundRequisition_Year + "']")).click();
					...
					while (true) {
						try {
							...
							// waithelper.waitForElementwithFluentwait(driver,
							// bUSINESS_PARTNER_SETUP_BusinessPartnerObj.businessPartner_ClickOnNextYear());
					...
					waithelper.waitForElementToVisibleWithFluentWait(driver,
							driver.findElement(
									By.xpath("//td[@aria-label='" + PettyCashTestDataType.FundRequisition_Year + "']")),
							60, 5);
					WebElement Year = driver.findElement(
							By.xpath("//td[@aria-label='" + PettyCashTestDataType.FundRequisition_Year + "']"));
					Year.click();
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				driver.findElement(By.xpath("//td[@aria-label='" + PettyCashTestDataType.FundRequisition_FullMonth + " "
						+ PettyCashTestDataType.FundRequisition_Date + ", " + PettyCashTestDataType.FundRequisition_Year
						+ "']/span")),
				60, 5);
		WebElement FundRequisitionDate = driver.findElement(By.xpath("//td[@aria-label='"
				+ PettyCashTestDataType.FundRequisition_FullMonth + " " + PettyCashTestDataType.FundRequisition_Date
				+ ", " + PettyCashTestDataType.FundRequisition_Year + "']/span"));
	...
	public void the_report_is_displaying_all_fund_requisition_details() throws InterruptedException {
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				ReconciliationObj.Reports_PettyCash_FundRequisitionReport(), 60, 5);
	...
	public void select_the_date_to_check_the_petty_cash_receipt_details_are_displaying() throws InterruptedException {
		...
		while (true) {
			try {
				// waithelper.waitForElementwithFluentwait(driver,
				// driver.findElement(By.xpath("//span[contains(text(),'"+PettyCashTestDataType.PettyCashReceipt_Month+"
				// "+PettyCashTestDataType.PettyCashReceipt_Year+"')]")));
				WebElement birthmonthandyear = driver
						.findElement(By.xpath("//span[contains(text(),'" + PettyCashTestDataType.PettyCashReceipt_Month
								+ " " + PettyCashTestDataType.PettyCashReceipt_Year + "')]"));
//				driver.findElement(By.xpath("//div/div/button")).getText().contains(bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthMonth+" "+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthYear);
				break;
			} catch (NoSuchElementException nosuchElement) {
...
//				System.out.println(headyear);
				...
				if (year < y1 && year < y2) {
					while (true) {
						try {
							// waithelper.waitForElementwithFluentwait(driver,
							// driver.findElement(By.xpath("//span[contains(text(),'"+PettyCashTestDataType.PettyCashReceipt_Year+"')]")));
							WebElement Year = driver.findElement(By.xpath(
									"//span[contains(text(),'" + PettyCashTestDataType.PettyCashReceipt_Year + "')]"));
							break;
						} catch (NoSuchElementException nosuchElement1) {
							// waithelper.waitForElementwithFluentwait(driver,
							// bUSINESS_PARTNER_SETUP_BusinessPartnerObj.businessPartner_ClickOnPreviousYear());
					...
					waithelper.waitForElementToVisibleWithFluentWait(driver,
							...
							60, 5);
					WebElement Year = driver.findElement(
							By.xpath("//span[contains(text(),'" + PettyCashTestDataType.PettyCashReceipt_Year + "')]"));
					Year.click();

					waithelper.waitForElementToVisibleWithFluentWait(driver,
							driver.findElement(
									By.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashReceipt_FullMonth
											+ " " + PettyCashTestDataType.PettyCashReceipt_Year + "']")),
							60, 5);
					driver.findElement(By.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashReceipt_FullMonth
							+ " " + PettyCashTestDataType.PettyCashReceipt_Year + "']")).click();
					...
					waithelper.waitForElementToVisibleWithFluentWait(driver,
							driver.findElement(By
									.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashReceipt_Year + "']")),
							60, 5);
					WebElement Year = driver.findElement(
							By.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashReceipt_Year + "']"));
					Year.click();
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				driver.findElement(By.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashReceipt_FullMonth
						+ " " + PettyCashTestDataType.PettyCashReceipt_Date + ", "
						+ PettyCashTestDataType.PettyCashReceipt_Year + "']/span")),
				60, 5);
		WebElement ReceiptDate = driver.findElement(By.xpath("//td[@aria-label='"
				+ PettyCashTestDataType.PettyCashReceipt_FullMonth + " " + PettyCashTestDataType.PettyCashReceipt_Date
				+ ", " + PettyCashTestDataType.PettyCashReceipt_Year + "']/span"));
...
//    	Thread.sleep(1000);
		...
		Thread.sleep(3000);
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				ReconciliationObj.Reports_PettyCash_PettyCashReceiptReport(), 60, 5);
...
//    	Thread.sleep(6000);
		while (true) {
			try {
				// waithelper.waitForElementwithFluentwait(driver,
				// driver.findElement(By.xpath("//span[contains(text(),'"+PettyCashTestDataType.PettyCashRegister_Month+"
				// "+PettyCashTestDataType.PettyCashRegister_Year+"')]")));
				WebElement birthmonthandyear = driver
						.findElement(By.xpath("//span[contains(text(),'" + PettyCashTestDataType.PettyCashRegister_Month
								+ " " + PettyCashTestDataType.PettyCashRegister_Year + "')]"));
//				driver.findElement(By.xpath("//div/div/button")).getText().contains(bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthMonth+" "+bUSINESS_PARTNER_SETUP_BusinessPartnerTestDataType.BirthYear);
				break;
			} catch (NoSuchElementException nosuchElement) {
...
//				System.out.println(headyear);
				...
				if (year < y1 && year < y2) {
					while (true) {
						try {
							// waithelper.waitForElementwithFluentwait(driver,
							// driver.findElement(By.xpath("//span[contains(text(),'"+PettyCashTestDataType.PettyCashRegister_Year+"')]")));
							WebElement Year = driver.findElement(By.xpath(
									"//span[contains(text(),'" + PettyCashTestDataType.PettyCashRegister_Year + "')]"));
							break;
						} catch (NoSuchElementException nosuchElement1) {
							// waithelper.waitForElementwithFluentwait(driver,
							// bUSINESS_PARTNER_SETUP_BusinessPartnerObj.businessPartner_ClickOnPreviousYear());
					...
					WebElement Year = driver.findElement(By
							.xpath("//span[contains(text(),'" + PettyCashTestDataType.PettyCashRegister_Year + "')]"));
					Year.click();

					waithelper.waitForElementToVisibleWithFluentWait(driver,
							driver.findElement(
									By.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashRegister_FullMonth
											+ " " + PettyCashTestDataType.PettyCashRegister_Year + "']")),
							60, 5);
					driver.findElement(By.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashRegister_FullMonth
							+ " " + PettyCashTestDataType.PettyCashRegister_Year + "']")).click();
					...
					waithelper.waitForElementToVisibleWithFluentWait(driver,
							driver.findElement(By
									.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashRegister_Year + "']")),
							60, 5);
					WebElement Year = driver.findElement(
							By.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashRegister_Year + "']"));
					Year.click();
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				driver.findElement(By.xpath("//td[@aria-label='" + PettyCashTestDataType.PettyCashRegister_FullMonth
						+ " " + PettyCashTestDataType.PettyCashRegister_Date + ", "
						+ PettyCashTestDataType.PettyCashRegister_Year + "']/span")),
				60, 5);
		WebElement registerDate = driver.findElement(By.xpath("//td[@aria-label='"
				+ PettyCashTestDataType.PettyCashRegister_FullMonth + " " + PettyCashTestDataType.PettyCashRegister_Date
				+ ", " + PettyCashTestDataType.PettyCashRegister_Year + "']/span"));
	...
	public void the_report_is_displaying_all_the_petty_cash_register_details() throws InterruptedException {
		...
		Thread.sleep(3000);
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				ReconciliationObj.Reports_PettyCash_PettyCashRegisterReport(), 60, 5);
