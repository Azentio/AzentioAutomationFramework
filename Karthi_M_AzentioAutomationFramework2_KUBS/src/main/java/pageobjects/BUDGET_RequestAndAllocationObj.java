...
public class BUDGET_RequestAndAllocationObj {
	...
	public WebElement budgetAllocationAlertRemarks() {
		return budget_allocation_alert_remarks;
	}
	@FindBy(xpath = "//ion-button[contains(text(),'Submit')]")
	private WebElement budget_allocation_alert_submit_button;

	public WebElement budgetAllocationAlertsubmitButton() {
		return budget_allocation_alert_submit_button;
	}
	...
	/*@FindBy(xpath="//datatable-row-wrapper[12]/datatable-body-row/div/datatable-body-cell[2]//app-kub-currency/input")
	private WebElement requestandallocation_monthly_budget_amount1;
	public WebElement  budgetRequestAndAllocationMonthlyBudgetAmount1() {
		return requestandallocation_monthly_budget_amount1;
	}*/
	...
	@FindBy(xpath = "//datatable-row-wrapper[12]//datatable-body-cell[2]/div/app-kub-currency/input")
	...
	private WebElement budgetrequest_and_allocation_notification_icon;
	public WebElement budgetRequestAndAllocationNotificationIcon()
	{
		return budgetrequest_and_allocation_notification_icon;
	}
	@FindBy(xpath="//app-inbox//datatable-row-wrapper[1]/datatable-body-row/div/datatable-body-cell[2]//span")
	private WebElement budget_requestAndAllocation_first_reference_id;
	public WebElement budgetRequestAndAllocationFirstReferenceId()
	{
		return budget_requestAndAllocation_first_reference_id;
		
	}
	@FindBy(xpath="//app-inbox//datatable-row-wrapper[1]/datatable-body-row/div/datatable-body-cell[1]//ion-button")
	private WebElement budget_requestAndAllocation_first_record;
	public WebElement budgetRequestAndAllocationFirstRecord()
	{
		return budget_requestAndAllocation_first_record;
		
	}
	 @FindBy(xpath="//ion-header/ion-toolbar[1]/ion-buttons[2]/ion-button[4]")
	    private WebElement budget_requestAndAllocation_user_name;
	    public WebElement budgetRequestAndAllocationUserName()
	    {
	    	return budget_requestAndAllocation_user_name;
	    }
	    @FindBy(xpath="//ion-label[contains(text(),'Logout')]")
	    private WebElement budget_requestAndAllocation_logout_button;
	    public WebElement budgetRequestAndAllocationLogoutButton()
	    {
			return budget_requestAndAllocation_logout_button;
	    	
	    }
	    @FindBy(xpath="//div[@id='toast-container']//button")
		private WebElement budget_requestAndAllocation_alert_close;
		public WebElement budgetRequestAndAllocationAlertClose()
		{
			return budget_requestAndAllocation_alert_close;
		}
