...
public class KUBS_CheckerObj {
	...
	@FindBy(xpath = "//ion-label[contains(text(),'Open pool')]")
	private WebElement checker_openpool;

	public WebElement checkerOpenpool() {
		return checker_openpool;
	}
	...
	@FindBy(xpath = "//ion-title[contains(text(),'Open Pool')]")
	private WebElement checker_open_pool;

	public WebElement checkerOpenPool() {
		return checker_open_pool;
	}
