...
public class BUDGET_UAT_BudgetDefinition extends BaseClass {
	...
	public void click_on_save_button() throws Throwable {
		...
		Assert.assertEquals(budgetCreationObj.budgetCreation_ReviewerId().getText(),
				"Saved successfully, Workflow initiated kindly submit record from inbox");
...
//		Thread.sleep(1000);
	...
	public void choose_first_record_in_the_notification_record() throws Throwable {
		...
		excelData.updateTestData("KUBS_FAT_UAT_010_003_01_D1","Reference ID",referenceID);
		testData1 = excelData.getTestdata("KUBS_FAT_UAT_010_003_01_D1");
...
//		javascriptHelper.JSEClick( budgetCreationObj.notificationSearchIcon());
	...
	public void enter_remark_in_confirmation_alert() throws Throwable {
		 ...
		 */
		budgetCreationObj.budgetCreation_AlertRemarks().sendKeys(testData1.get("remark"));
	...
	public void capture_the_reviewer_id_in_pop_up_which_is_open_when_we_submit_our_record_in_maker_stage()
		...
		excelData.updateTestData("KUBS_FAT_UAT_010_003_01_D1","Reviewer ID",revID);
		testData1 = excelData.getTestdata("KUBS_FAT_UAT_010_003_01_D1");
...
//		Thread.sleep(1000);		
	...
	public void login_with_reviewer_credentials() throws Throwable {
		 ...
		 */
		Thread.sleep(3000);
		kubsLogin.logintoAzentioappReviewer(userType, testData1.get("Reviewer ID"));
		...
		for (int i = 0; i <= 300; i++) {
			try {
				...
				waitHelper.waitForElement(driver, 3000, driver
						.findElement(By.xpath(before_xpath +testData1.get("Reference ID")+ after_xpath)));
...
//		Thread.sleep(2000);
	...
	public void enter_the_remark_in_alert() throws Throwable {
		...
		kubsReviewerObj.reviewerAlertRemarks().sendKeys(testData1.get("approvalCommentsFromReviewer"));
	}
		...
		while (true) {
			...
			try {
				...
				kubsReviewerObj.reviewerAlertRemarks()
						.sendKeys(testData1.get("approvalCommentsFromReviewer"));
			}
		}
	}
...
//				80, 500);
				WebElement climeButton = driver
						.findElement(By.xpath(before_xpath +testData1.get("Reference ID")+ after_xpath_claim));
	...
	public void give_alert_remark() throws Throwable {
		...
		for (int i = 0; i <= 50; i++) {
			try {
				...
				kubsCheckerObj.checkerRemarks().sendKeys(testData1.get("approvalCommentsFromChecker"));
				break;
			} catch (Exception e) {
				if (i == 50) {
					if (i == 50) {
