...
public class AccountReceivable_UpdateDepositedCheque extends BaseClass { 
	...
	AccountReceivable_UpdateDepositedChequeTestDataType accountReceivable_UpdateDepositedChequeTestDataType = jsonReader.getUpdateDepositedChequeByName("Maker");
