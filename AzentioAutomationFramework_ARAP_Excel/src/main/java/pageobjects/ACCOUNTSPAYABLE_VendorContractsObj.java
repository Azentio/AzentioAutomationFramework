...
//	@FindBy(xpath="//datatable-row-wrapper[1]/datatable-body-row[1]/div[2]/datatable-body-cell[1]/div[1]/ion-buttons[1]/ion-button[1]")
	...
	private WebElement  accountPayable_VendorContracts_ActionButton;
	public WebElement  accountPayable_VendorContracts_ActionButton() {
		return accountPayable_VendorContracts_ActionButton;
	}
...
//	@FindBy(xpath = "//ion-textarea/div/textarea[@name='remarks']")
	...
	private WebElement accountPayable_VendorContracts_InboxSearchIcon;

	public WebElement accountPayable_VendorContracts_InboxSearchIcon() {
		return accountPayable_VendorContracts_InboxSearchIcon;
	}

	// Inbox Search icon
	@FindBy(xpath = "//div[2]/datatable-header-cell[3]/div[1]/ion-input[1]/input[1]")
	private WebElement accountPayable_VendorContracts_EventCodeSearch;

	public WebElement accountPayable_VendorContracts_EventCodeSearch() {
		return accountPayable_VendorContracts_EventCodeSearch;
	}
