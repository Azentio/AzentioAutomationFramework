...
public class AccountPayable_InvoiceBookingObj {
	...
	// Entity Branch 	//ion-row[1]/ion-col[1]/app-kub-lov[1]/span[1]/ng-select[1]/div[1]/div[1]/div[3]/input[1]
		@FindBy(xpath = "//ion-row[1]/ion-col[1]/app-kub-lov[1]/span[1]/ng-select[1]/div[1]/div[1]/div[3]/input[1]")
		...
		private WebElement  accountPayable_InvoiceBooking_ClickOnNextMonth;
		
		public WebElement accountPayable_InvoiceBooking_ClickOnNextMonth() {
			return accountPayable_InvoiceBooking_ClickOnNextMonth;
		}
...
//		@FindBy(xpath = "(//ion-toolbar/ion-buttons/ion-button[2])[2]")
		...
		private WebElement  accountPayable_InvoiceBooking_NotificationButton;
		
		public WebElement accountPayable_InvoiceBooking_NotificationButton() {
			return accountPayable_InvoiceBooking_NotificationButton;
		}
		...
		private WebElement accountPayable_InvoiceBooking_FirstReferenceId;

		public WebElement accountPayable_InvoiceBooking_FirstReferenceId() {
			return accountPayable_InvoiceBooking_FirstReferenceId;
		}

		//record status
		@FindBy(xpath = "//body/div/div/div/div[1]")
		private WebElement accountPayable_InvoiceBooking_RecordStatus;

		public WebElement accountPayable_InvoiceBooking_RecordStatus() {
			return accountPayable_InvoiceBooking_RecordStatus;
		}
		
		//Maker Notification NextButton
		@FindBy(xpath = "//datatable-pager[1]/ul[1]/li[8]/a[1]/i[1]")
		private WebElement accountPayable_InvoiceBooking_NotificationNextButton;

		public WebElement accountPayable_InvoiceBooking_NotificationNextButton() {
			return accountPayable_InvoiceBooking_NotificationNextButton;
		}
		// Submit
		@FindBy(xpath = "//span[contains(text(),'Submit')]")
		private WebElement accountPayable_InvoiceBooking_SubmitButton;

		public WebElement accountPayable_InvoiceBooking_SubmitButton() {
			return accountPayable_InvoiceBooking_SubmitButton;
		}
		// Submit by maker
		@FindBy(xpath = "//ion-row/ion-col/ion-button")
		private WebElement accountPayable_InvoiceBooking_Submit;

		public WebElement accountPayable_InvoiceBooking_Submit() {
			return accountPayable_InvoiceBooking_Submit;
		}
