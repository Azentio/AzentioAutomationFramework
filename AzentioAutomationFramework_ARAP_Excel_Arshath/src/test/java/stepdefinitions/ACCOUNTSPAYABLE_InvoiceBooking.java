...
//		try {
//
//		waithelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'" + testData.get("InvoiceBillingMonth") + " "+ testData.get("InvoiceBillingYear") + "')]")));
//		WebElement monthAndYear = driver.findElement(By.xpath("//span[contains(text(),'" + testData.get("InvoiceBillingMonth") + " " + testData.get("InvoiceBillingYear") + "')]"));
//		break;
//			}
//
//		catch (NoSuchElementException nosuchElement) {
//		waithelper.waitForElementToVisibleWithFluentWait(driver,aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_ClickOnNextMonth(),15,1);
//		aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_ClickOnNextMonth().click();
//				
//		}
//		}
//		WebElement InvoiceBillingDate = driver.findElement(By.xpath("//td[@aria-label='" + testData.get("InvoiceBillingFullMonth") + " "+ testData.get("InvoiceBillingDate") + ", " + testData.get("InvoiceBillingYear") + "']/span"));
//		clicksAndActionHelper.doubleClick(InvoiceBillingDate);
//
//	    waithelper.waitForElementToVisibleWithFluentWait(driver,aCCOUNTSPAYABLE_InvoiceBookingObj.accountPayable_InvoiceBooking_FlatDiscount(),15,1);
...
//		waithelper.waitForElementToVisibleWithFluentWait(driver,aCCOUNTSPAYABLE_InvoiceBookingObj.accountPayable_InvoiceBooking_EarlyPaymentDiscountType(),15,1);
...
//
//	    waithelper.waitForElementToVisibleWithFluentWait(driver,aCCOUNTSPAYABLE_InvoiceBookingObj.accountPayable_InvoiceBooking_EarlyPaymentDiscountPercentBasis(),15,1);
...
//			try {
//
//		waithelper.waitForElement(driver, 3000, driver.findElement(By.xpath("//span[contains(text(),'" + aCCOUNTSPAYABLE_InvoiceBookingTestDataType.PaymentMonth + " " + aCCOUNTSPAYABLE_InvoiceBookingTestDataType.PaymentYear + "')]")));
//		WebElement monthAndYear = driver.findElement(By.xpath("//span[contains(text(),'" + aCCOUNTSPAYABLE_InvoiceBookingTestDataType.PaymentMonth + " " + aCCOUNTSPAYABLE_InvoiceBookingTestDataType.PaymentYear + "')]"));
//		break;
//			}
//
//		catch (NoSuchElementException nosuchElement) {
...
//		WebElement monthAndYear = driver.findElement(By.xpath("//span[contains(text(),'" + aCCOUNTSPAYABLE_InvoiceBookingTestDataType.InvoiceBillingMonth + " " + aCCOUNTSPAYABLE_InvoiceBookingTestDataType.InvoiceBillingYear + "')]"));
//		break;
//			}
//
//				catch (NoSuchElementException nosuchElement) {
...
//    	for (int i = 1; i <= 35; i++) {
//			try {
//		    	waithelper.waitForElement(driver, 3000,driver.findElement(By.xpath("//span[text()='" +jsonWriter.readReferancedata()+ "']")));	
//				WebElement referanceID = driver.findElement(By.xpath("//span[text()='" +  jsonWriter.readReferancedata() + "']"));	
...
////    	waithelper.waitForElement(driver, 2000, driver.findElement(By.xpath(before_xpath +jsonWriter.readReferancedata()+after_xpath)));
//    	waithelper.waitForElementToVisibleWithFluentWait(driver, driver.findElement(By.xpath(before_xpath +jsonWriter.readReferancedata()+after_xpath)), 10, 1);
...
//		aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_EventCodeSearch().sendKeys("AP_BILL_BOOKING");
...
//		while(true) {
//			try {waithelper.waitForElement(driver, 4000, aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_Submit());
...
//    }
//    @And("^approve the record by the reviewer one user$")
//	public void approve_the_record_by_the_reviewer_one_user() throws InterruptedException, IOException, ParseException {
...
//		Thread.sleep(1000);
//		for (int i = 1; i < 10; i++) {
//			waithelper.waitForElement(driver, 2000, driver.findElement(By.xpath(before_xpath + i + after_xpath)));
...
//				aCCOUNTSPAYABLE_InvoiceBookingObj.accountPayable_InvoiceBooking_ApprovedByReviewerRemark1().sendKeys(aCCOUNTSPAYABLE_InvoiceBookingTestDataType.ApprovedByReviewer);
...
//
//		waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath("//span[text()='" + jsonWriter.readReferancedata() + "']/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell/div/ion-buttons/ion-button")));
//		driver.findElement(By.xpath("//span[text()='" + jsonWriter.readReferancedata() + "']/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell/div/ion-buttons/ion-button")).click();
////    	waithelper.waitForElement(driver, 2000, aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_NotificationButton());
////		aCCOUNTSPAYABLE_VendorContractsObj.accountPayable_VendorContracts_NotificationButton().click();
////		Thread.sleep(2000);
