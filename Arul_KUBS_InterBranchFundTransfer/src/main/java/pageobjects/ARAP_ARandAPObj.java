...
public class ARAP_ARandAPObj {
	...
	@FindBy(xpath = "//ion-icon[@name='mail-unread-outline']//parent::ion-button")
	...
	@FindBy(xpath = "//ion-label[text()='Please enter remark ']/following-sibling::ion-textarea//textarea")
