...
public class GL_REPORTS_Obj {
	...
	private WebElement searchAccountingBookName;
	public WebElement searchAccountingBookName() {
		return searchAccountingBookName;
	}
	...
	//
	 ...
	 {
		 return accountingBookDefenition_SearchBookName;
	 }
	...
	public WebElement getCategoryCode() {
	 ...
	 @FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[14]//span")
	 private WebElement getAccountingBookName_Status;
	 public WebElement getAccountingBookNameStatus()
	 {
		 return getAccountingBookName_Status;
	 }
	...
	@FindBy(xpath="(//datatable-body-cell[3]//span)[1]")
	private WebElement getBook_Name;
	public WebElement getBookName()
	{
		return getBook_Name;
	}
	@FindBy(xpath="(//span[text()=' Active ']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[11])[1]")
	private WebElement accountingSetup_ActiveBookName;
	public WebElement accountingSetupActiveBookName()
	{
		return accountingSetup_ActiveBookName;
	}
	@FindBy(xpath="(//span[text()=' Active ']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[13]//ion-button[2])[1]")
    private WebElement accountingSetUp_ActiveBookRecord;
	public WebElement AccountingSetUpActiveBookRecord()
	{
		return accountingSetUp_ActiveBookRecord;
	}
	@FindBy(xpath="//span[text()=' In-Active ']/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell[13]//ion-button[2]")
    private WebElement accountingSetUp_InActiveBookRecord;
	public WebElement AccountingSetUpInActiveBookRecord()
	{
		return accountingSetUp_InActiveBookRecord;
	}
	...
	public WebElement existingRecordToastMessage() {
		return existingRecord_ToastMessage;
	}
    
	// success message close
	@FindBy(xpath = "//div[@id='toast-container']//button[@aria-label='Close']")
	private WebElement GL_SuccessMessageClose;

	public WebElement GL_SuccessMessageClose() {
		return GL_SuccessMessageClose;
	}
