...
public class KUBS_MakerObj {
    ...
    @FindBy(xpath="//div[contains(text(),'Finance')]//parent::div[@class='alert-button-inner sc-ion-alert-md']")
    ...
    private WebElement OkButtonInFinanceOption;
    public WebElement OkButtonInFinanceOption() {
		return OkButtonInFinanceOption;
