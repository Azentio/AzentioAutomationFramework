...
public class GL_Accounting_Setup_Obj {
	...
	@FindBy(xpath = "(//span[text()='IBFT']/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell[2]//ion-button)[1]")
	private WebElement interBranchFundTransfer_ActionButton;

	public WebElement interBranchFundTransferActionButton() {
	...
	@FindBy(xpath = "(//span[text()='IBFT']/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell[1]//span)[1]")
	private WebElement interBranchFundTransfer_ReferanceId;
