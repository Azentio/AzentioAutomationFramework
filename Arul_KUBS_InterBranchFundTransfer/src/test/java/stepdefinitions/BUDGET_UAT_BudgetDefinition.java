...
//		Thread.sleep(1000);		
		waitHelper.waitForElementToVisibleWithFluentWait(driver, budgetCreationObj.budgetCreationLogoutButton(), 10,
				500);
				javascriptHelper.JavaScriptHelper(driver);
	...
	public void click_on_notification_button() throws Throwable {
		 ...
		 */
		waitHelper.waitForElementToVisibleWithFluentWait(driver, kubsReviewerObj.reviewerNotificationIcon(), 60, 500);
		kubsReviewerObj.reviewerNotificationIcon().click();
