...
//	    }
	...
	public void store_the_asset_refeference_number_in_asset_undertaken_excel_database_for_return_undertaken_asset()
			throws Throwable {
		String xpath = "//datatable-row-wrapper[1]//span[text()=' " + assetCreationTestData.get("AssetCode")
				+ " ']//ancestor::datatable-body-cell//following-sibling::datatable-body-cell[2]//span";
		String assetReferenceNumber = "";
		...
		excelDataForAssetTransfer.updateTestData("KUBS_FAT_UAT_005_001_D9", "AssetReferenceNumber",
				assetReferenceNumber);
	}

	@And("^store the asset item number in asset undertaken excel database for return undertaken asset$")
	public void store_the_asset_item_number_in_asset_undertaken_excel_database_for_return_undertaken_asset()
			throws Throwable {
		excelDataForAssetTransfer.updateTestData("KUBS_FAT_UAT_005_001_D9", "AssetItemNumber",
				assetCreationTestData.get("UpdatedItemNumber"));
	}
