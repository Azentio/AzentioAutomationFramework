...
//		inventoryManagamentObj.inventoryManagament_InventoryRequest_AddButton().click();
	...
	public void fill_all_the_mandatory_fields() throws Throwable {
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryManagament_InventoryRequest_BranchCode());
		inventoryManagamentObj.inventoryManagament_InventoryRequest_BranchCode().click();
		inventoryManagamentObj.inventoryManagament_InventoryRequest_BranchCode()
				.sendKeys(inventoryManagementTestDataType.BranchCode);
		inventoryManagamentObj.inventoryManagament_InventoryRequest_BranchCode().sendKeys(Keys.ENTER);
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryManagament_InventoryRequest_ItemCodeDescriptionButton());
...
//		inventoryManagamentObj.inventoryManagament_InventoryRequest_SavingAccountChequeRadioButton().click();
		...
		radioButtonHelper.radioButton(inventoryManagementTestDataType.ItemCodeDescription);
...
//		waithelper.waitForElement(driver, 4000,inventoryManagamentObj.inventoryManagament_InventoryRequest_RequestTypeButton());
		waithelper.waitForElementwithFluentwait(driver,
				inventoryManagamentObj.inventoryManagament_InventoryRequest_RequestTypeButton());
...
//		waithelper.waitForElement(driver, 3000,inventoryManagamentObj.inventoryManagament_InventoryRequest_RequestTypeNormalRadioButton());
		while (true) {
			try {
				waithelper.waitForElementwithFluentwait(driver,
						inventoryManagamentObj.inventoryManagament_InventoryRequest_RequestTypeNormalRadioButton());
...
//		waithelper.waitForElement(driver, 2000,inventoryManagamentObj.inventoryManagament_InventoryRequest_RequestQty());
		waithelper.waitForElementwithFluentwait(driver,
				inventoryManagamentObj.inventoryManagament_InventoryRequest_RequestQty());
		inventoryManagamentObj.inventoryManagament_InventoryRequest_RequestQty().click();
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryManagament_InventoryRequest_RequestQty());
		inventoryManagamentObj.inventoryManagament_InventoryRequest_RequestQty()
				.sendKeys(inventoryManagementTestDataType.RequestQty);
...
//We need to change instrument code & Description every time. If not changed it will show error instrument code already exist	
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_InstrumentCodeTextBox());
		inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_InstrumentCodeTextBox().click();
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_InstrumentCodeTextBox());
		inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_InstrumentCodeTextBox()
				.sendKeys(inventoryManagementTestDataType.InstrumentCode);
		inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_InstrumentCodeTextBox().sendKeys(Keys.ENTER);

		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_InstrumentDescriptionTextBox());
		inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_InstrumentDescriptionTextBox().click();
		inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_InstrumentDescriptionTextBox()
				.sendKeys(inventoryManagementTestDataType.InstrumentDescription);
		inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_InstrumentDescriptionTextBox()
				.sendKeys(Keys.ENTER);

		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_StartingSerialNumber());
		inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_StartingSerialNumber().click();
		inventoryManagamentObj.inventoryMaintenance_InstrumentCodeMaster_StartingSerialNumber()
				.sendKeys(inventoryManagementTestDataType.StartingSerialNumber);
...
//		 waithelper.waitForElement(driver, 2000,inventoryManagamentObj.inventoryMaintanance_InstrumentCodeMaster_SaveButton());
	...
	public void fill_all_the_required_field_for_issuing_inventories() throws Throwable {
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code());
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code()
				.sendKeys(inventoryManagementTestDataType.AccessBranchCodeForIssue);
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_InventoryBranchCode());
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_InventoryBranchCode()
				.sendKeys(inventoryManagementTestDataType.InventoryBranchCodeForIssue);
	...
	public void fill_all_the_required_fiel_for_receiving_inventories() throws Throwable {
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code());
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code()
				.sendKeys(inventoryManagementTestDataType.AccessBranchCodeForReceive);
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code().sendKeys(Keys.ENTER);
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_InventoryBranchCode());
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_InventoryBranchCode()
				.sendKeys(inventoryManagementTestDataType.InventoryBranchCodeForReceive);
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_InventoryBranchCode().sendKeys(Keys.ENTER);
	}
	...
	public void fill_all_the_required_field_for_ordering_inventories() throws Throwable {
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code());
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code()
				.sendKeys(inventoryManagementTestDataType.AccessBranchCodeForOrder);
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code().sendKeys(Keys.ENTER);
	...
	public void fill_all_the_required_field_for_requesting_inventories() throws Throwable {
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code());
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code()
				.sendKeys(inventoryManagementTestDataType.AccessBranchCodeForRequest);
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_Access_Branch_Code().sendKeys(Keys.ENTER);
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_InventoryBranchCode());
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_InventoryBranchCode()
				.sendKeys(inventoryManagementTestDataType.InventoryBranchCodeForRequest);
		inventoryManagamentObj.inventoryMaintenance_InventoryAccessMaster_InventoryBranchCode().sendKeys(Keys.ENTER);
	...
	public void choose_from_date() throws Throwable {
		...
		while (true) {
			try {
				...
				waithelper.waitForElement(driver, 3000,
						driver.findElement(By.xpath("//span[contains(text(),'" + inventoryManagementTestDataType.GlMonth
								+ " " + inventoryManagementTestDataType.GlYear + "')]")));
				WebElement monthAndYear = driver
						.findElement(By.xpath("//span[contains(text(),'" + inventoryManagementTestDataType.GlMonth + " "
								+ inventoryManagementTestDataType.GlYear + "')]"));
				break;
			}
		...
		WebElement FinalDay = driver.findElement(By.xpath("//td[@aria-label='"
				+ inventoryManagementTestDataType.GlFullMonth + " " + inventoryManagementTestDataType.GlDay + ", "
...
//			}
	...
	public void click_on_request_referance_no_code() throws Throwable {
		...
		waithelper.waitForElementwithFluentwait(driver, inventoryManagamentObj.inventoryRequestReferanceNumber());
		inventoryManagamentObj.inventoryRequestReferanceNumber()
				.sendKeys(inventoryManagementTestDataType.requestReferanceNo);
...
//				waithelper.waitForElement(driver, 2000, inventoryManagamentObj.StockConfirm_Remark());
		waithelper.waitForElementwithFluentwait(driver, inventoryManagamentObj.StockConfirm_Remark());
...
//				waithelper.waitForElement(driver, 2000, inventoryManagamentObj.StockConfirm_RemarkSubmit());
		waithelper.waitForElementwithFluentwait(driver, inventoryManagamentObj.StockConfirm_RemarkSubmit());
...
//				waithelper.waitForElement(driver, 2000, inventoryManagamentObj.StockConfirm_ReviewerId());
		waithelper.waitForElementwithFluentwait(driver, inventoryManagamentObj.StockConfirm_ReviewerId());
...
// 				waithelper.waitForElement(driver, 3000, inventoryManagamentObj.inventoryReportIcon());
	...
	public void choose_from_date_in_the_calender() throws Throwable {
		...
		while (true) {
			try {
				...
				waithelper.waitForElement(driver, 3000,
						driver.findElement(By.xpath("//span[contains(text(),'" + inventoryManagementTestDataType.GlMonth
								+ " " + inventoryManagementTestDataType.GlFromYear + "')]")));
				WebElement monthAndYear = driver
						.findElement(By.xpath("//span[contains(text(),'" + inventoryManagementTestDataType.GlMonth + " "
								+ inventoryManagementTestDataType.GlFromYear + "')]"));
				break;
		...
		WebElement FinalDay = driver.findElement(By.xpath("//td[@aria-label='"
				+ inventoryManagementTestDataType.GlFullMonth + " " + inventoryManagementTestDataType.GlDay + ", "
				+ inventoryManagementTestDataType.GlFromYear + "']/span"));
		Thread.sleep(1000);
		clicksAndActionHelper.doubleClick(FinalDay);
	...
	public void fill_the_details_of_stock_confirmation() throws Throwable {
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.Report_report_StockConfirmationReport_acceptStatus());
		inventoryManagamentObj.Report_report_StockConfirmationReport_acceptStatus().click();
		inventoryManagementTestDataType = jsonReader.getInventoryManagementByName("Maker");
		inventoryManagamentObj.Report_report_StockConfirmationReport_acceptStatus()
				.sendKeys(inventoryManagementTestDataType.AcceptStatus);
	...
	public void fill_the_form_for_inventory_access_detail_report() throws Throwable {
		...
		inventoryManagamentObj.report_inventoryItemDetail_ItemDescription()
				.sendKeys(inventoryManagementTestDataType.ItemDescriptionForInvtItemDetails);
	...
	public void fill_the_form_for_inventory_request_report() throws Throwable {
		...
		inventoryManagamentObj.report_inventoryRequest_RequestReferenceNo()
				.sendKeys(inventoryManagementTestDataType.RequestReferenceNumber);
	...
	public void fill_the_form_for_purchase_requisition_report() throws Throwable {
		...
		inventoryManagamentObj.report_PurchaseRequsition_IndentReferenceNo()
				.sendKeys(inventoryManagementTestDataType.IndentReferenceNo);
...
//----------  KUBS_INV_MGMT_UAT_007_004---------
	...
	public void fill_the_form_for_stock_issuance_report() throws Throwable {
		...
		inventoryManagamentObj.report_StockIssuance_IssuanceReffrenceNo()
				.sendKeys(inventoryManagementTestDataType.IssueReferenceNo);
...
//----------KUBS_INV_MGMT_UAT_007_006-------
	...
	public void fill_the_form_for_stock_return_report() throws Throwable {
		...
		inventoryManagamentObj.report_StockReturn_returntype_Textbox()
				.sendKeys(inventoryManagementTestDataType.ReturnType);
...
//-------------KUBS_INV_MGMT_UAT_007_009-------------
	...
	public void fill_the_form_for_inventory_item_details_report() throws Throwable {
		...
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.report_InventoryItemDetails_ItemDescription_textbox());
		inventoryManagamentObj.report_InventoryItemDetails_ItemDescription_textbox().click();
		inventoryManagamentObj.report_InventoryItemDetails_ItemDescription_textbox()
				.sendKeys(inventoryManagementTestDataType.Itemdescription);
...
//----------------------KUBS_INV_MGMT_UAT_007_010------------
	...
	public void fill_the_form_for_inventory_stock_receipt_report() throws Throwable {
		inventoryManagementTestDataType = jsonReader.getInventoryManagementByName("Maker");
		waithelper.waitForElement(driver, 2000,
				inventoryManagamentObj.report_inventoryStockReceipt_POReferenceTextbox());
		inventoryManagamentObj.report_inventoryStockReceipt_POReferenceTextbox().click();
		inventoryManagamentObj.report_inventoryStockReceipt_POReferenceTextbox()
				.sendKeys(inventoryManagementTestDataType.POReference);
...
//-------------KUBS_INV_MGMT_UAT_006_001-----------
	...
	public void fill_the_form_for_stock_return_report_for_return_the_inventories() throws Throwable {
		...
		inventoryManagamentObj.report_StockReturn_returntype_Textbox().click();
		inventoryManagamentObj.report_StockReturn_returntype_Textbox()
				.sendKeys(inventoryManagementTestDataType.ReturnTypeInventory);
		inventoryManagamentObj.report_StockReturn_returntype_Textbox().sendKeys(Keys.ENTER);
