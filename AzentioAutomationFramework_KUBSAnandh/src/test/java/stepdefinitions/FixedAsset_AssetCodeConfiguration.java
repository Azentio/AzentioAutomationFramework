	...
	//Eye Button
	 ...
	 @And("^get the test data for asset code configuration$")
	    ...
	    public void enter_the_asset_code_in_asset_code_configuration() throws Throwable {
	       waithelper.waitForElementToVisibleWithFluentWait(driver, fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AssetCode(), 20, 1);
	       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AssetCode().click();
	       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AssetCode().sendKeys(assetCodeConfigTestData.get("AssetCode"));
	       for (int i = 0; i <= 20; i++) {
				try {
					clickAndActionsHelper.moveToElement(driver.findElement(
							By.xpath("//span[text()='" + assetCodeConfigTestData.get("AssetCode") + "']")));
	    ...
	    public void enter_the_accounting_model_in_asset_code_configuration() throws Throwable {
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AccountingModel(), 20, 1);
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AccountingModel().click();
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AccountingModel().sendKeys(assetCodeConfigTestData.get("AccountingModel"));
	    ...
	    public void enter_the_asset_life_unit_in_asset_code_configuration() throws Throwable {
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AssetLifeUnit(), 20, 1);
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AssetLifeUnit().click();
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AssetLifeUnit().sendKeys(assetCodeConfigTestData.get("AssetLifeUnit"));
		       for (int i = 0; i <= 20; i++) {
					try {
						clickAndActionsHelper.moveToElement(driver.findElement(
	    ...
	    public void enter_the_asset_life_in_asset_code_configuration() throws Throwable {
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AssetLife(), 20, 1);
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AssetLife().click();
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_AssetLife().sendKeys(assetCodeConfigTestData.get("AssetLife"));	        
	    }
	    ...
	    public void enter_the_basis_for_depriciation_in_asset_code_configuration() throws Throwable {
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_BasisForDeperciation(), 20, 1);
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_BasisForDeperciation().click();
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_BasisForDeperciation().sendKeys(assetCodeConfigTestData.get("BasisForDepriciation"));
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_BasisForDeperciation().sendKeys(Keys.DOWN);
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_BasisForDeperciation().sendKeys(Keys.ENTER);    
	    }
	    ...
	    public void enter_the_depriciaton_method_in_asset_code_configuration() throws Throwable {
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_DeperciationMethod(), 20, 1);
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_DeperciationMethod().click();
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_DeperciationMethod().sendKeys(assetCodeConfigTestData.get("DepriciationMethod"));
	    ...
	    public void enter_the_depriciation_rounding_method_in_asset_code_configuration() throws Throwable {
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_DeperciationRoundingMethod(), 20, 1);
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_DeperciationRoundingMethod().click();
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_DeperciationRoundingMethod().sendKeys(assetCodeConfigTestData.get("DepriciationRoundingMethod"));
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_DeperciationRoundingMethod().sendKeys(Keys.DOWN);
		       fixedAsset_AssetCodeConfigurationObj.fixedAsset_AssetCodeConfiguration_DeperciationRoundingMethod().sendKeys(Keys.ENTER); 	        	        
	    }
	    ...
	    public void verify_asset_code_config_record_got_submitted_and_store_the_reviewer_id() throws Throwable {
			...
			excelData.updateTestData("KUBS_FAT_UAT_002_003_D1", "Reviewer ID", reviewerID); 
	    }
	    ...
	    public void validate_record_got_save_in_maker_stage() throws Throwable {
	     waithelper.waitForElementToVisibleWithFluentWait(driver, kubsCommonWebObj.kubsToastAlert(), 20, 1);
	     Assert.assertEquals(kubsCommonWebObj.kubsToastAlert().getText(), "Workflow initiated submit record from inbox.");
	     waithelper.waitForElementToVisibleWithFluentWait(driver, kubsCommonWebObj.kubsAlertClose(), 20, 1);
	     kubsCommonWebObj.kubsAlertClose().click();
	    }
	    ...
	    public void click_on_notification_icon_in_maker_stage() throws Throwable {
	        ...
	        kubsCommonWebObj.kubsNotificationIcon().click();
	    }
	    ...
	    public void store_the_asset_code_reference_number_in_excel_file() throws Throwable {
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, fixedAsset_AssetCodeConfigurationObj.assetCodeConfigNotificationRecordReferenceNo(), 20, 1);
	    	
	     excelData.updateTestData("KUBS_FAT_UAT_002_003_D1", "Reference ID", fixedAsset_AssetCodeConfigurationObj.assetCodeConfigNotificationRecordReferenceNo().getText());
	    }
	    @And("^select the asset code configuration record$")
	    public void select_the_asset_code_configuration_record() throws Throwable {
	        waithelper.waitForElementToVisibleWithFluentWait(driver, fixedAsset_AssetCodeConfigurationObj.assetCodeConfigNotificationRecord(), 20, 1);
	    ...
	    public void verify_approved_asset_code_appear_in_aset_code_config_list_view() throws Throwable {
	     ...
	     for(int i=0;i<=50;i++)
	     {
	    	 try
	    	 {
	    		 ...
	    		 Assert.assertTrue(driver.findElement(By.xpath(xpath)).isDisplayed(), "Asset code is not getting reflected");
	    		 break;
	    	 }
	    	 catch(Exception e)
	    	 {
	    ...
	    public void store_the_asset_code_in_asset_gl_configuration_database() throws Throwable {
	     ...
	     exceldataforGLConfig.updateTestData("KUBS_FAT_UAT_002_004_D1","AssetCode" , assetCodeConfigTestData.get("AssetCode"));
	    }
