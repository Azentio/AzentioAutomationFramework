...
public class FixedAsset_AssetCategory extends BaseClass {
	...
	public void verify_newly_created_asset_category_is_refelected_in_list_view() throws Throwable {
		String xpath = "//span[text()=' " + assetcatogoryTestdata.get("UpdateAssetItemcategory") + " ']";
		for (int i = 0; i <= 50; i++) {
			try {
...
//		System.out.println(testMap.get("AccountingModel"));
		excelDataAssetCode.updateTestData("KUBS_FAT_UAT_002_003_D1", "AssetCode", assetcatogoryTestdata.get("Asset_Code"));
	}
	...
	public void select_the_data_from_asset_category_dropdown() throws Throwable {
		...
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetCategoryInputField().sendKeys(Keys.DOWN);
	...
	public void enter_the_dta_in_asset_item_category() throws Throwable {
		...
		excelData.updateTestData("KUBS_FAT_UAT_002_002_D1", "UpdateAssetItemcategory", assetItemcategory);
	...
	public void fill_asset_category_mandatory_fields() throws InterruptedException {
		...
		// Asset Category
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetCategoryInputField(), 60, 5);
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetCategoryInputField().click();
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetCategoryInputField()
				.sendKeys(fixedAsset_AssetCategoryTestDataType.AssetCategory);
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetCategoryInputField().sendKeys(Keys.ENTER);

		// AssetSubCategory
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetSubCategory(), 60, 5);
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetSubCategory().click();
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetSubCategory()
				.sendKeys(fixedAsset_AssetCategoryTestDataType.AssetSubCategory);
		...
		int randomNum = random.nextInt(1000 - 1) + 1;
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetItemCategory(), 60, 5);
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetItemCategory().click();
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetItemCategory()
				.sendKeys(fixedAsset_AssetCategoryTestDataType.AssetItemCategory + randomNum);
		// fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetItemCategory().sendKeys(Keys.ENTER);

		// AssetDescription
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetDescription(), 60, 5);
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetDescription().click();
		fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AssetDescription()
				.sendKeys(fixedAsset_AssetCategoryTestDataType.AssetDescription);
	...
	public void click_on_fixed_asset_notification() {
		...
		for (int i = 0; i < 30; i++) {
			try {
				...
				clickAndActionsHelper.moveToElement(fixedAsset_AssetCategoryObj.fixedAsset_AssetCategory_AlertClose());
	...
	public void store_the_reference_number_of_asset_category_record() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				fixedAsset_AssetCategoryObj.assetCategoryReferenceNumber(), 20, 1);
		excelData.updateTestData("KUBS_FAT_UAT_002_002_D1", "Reference ID",
...
//alert Remark
	...
	public void store_the_reciewer_id_in_asset_category() throws Throwable {
		...
		excelData.updateTestData("KUBS_FAT_UAT_002_002_D1", "Reviewer ID", reviewerID);
