...
//				+ "')]/ancestor::datatable-body-cell/preceding-sibling::datatable-body-cell/div/ion-buttons/ion-button")));
    ...
    public void get_the_asset_reference_number_for_asset_return() throws Throwable {
        waitHelper.waitForElementToVisibleWithFluentWait(driver, assetReturnObj.fixedAssetNewAssetReferenceNumber(), 20, 1);
        assetReferenceNo.put("AssetReferenceNumberCreated", assetReturnObj.fixedAssetNewAssetReferenceNumber().getText());
