...
public class FixedAsset_AssetSerialNumCreation extends BaseClass {
	...
	ExcelData excelDataForAssetCreation = new ExcelData(excelPath, "FixedAsset_AssetCreation",
			"DataSet ID");
	@Then("^Click on Asset Serial Num Creation Eye button$")
	public void click_on_asset_serial_num_creation_eye_button() {
		// Eye Button
		WebElement eye = waithelper.waitForElementToVisibleWithFluentWait(driver,
				fixedAsset_AssetSerialNumCreationObj.fixedAsset_AssetSerialNumCreation_EyeIcon(), 60, 5);
	...
	public void select_the_asset_code_record_which_is_newly_completed_asset_gl_configuration() throws Throwable {
		String xpath = "//span[text()=' " + assetSerialNumberTestData.get("AssetCode")
	...
	public void store_the_fixed_asset_gl_serail_number_setup_record_reference_number_in_excel_data_base_and_select_the_record()
		...
		excelTestDataaForAssetSerialNumber.updateTestData("KUBS_FAT_UAT_002_005_D1", "Reference ID",
	...
	public void validate_the_submit_and_store_the_reviewer_id_of_asset_gl_setup_in_excel_database() throws Throwable {
		...
		excelTestDataaForAssetSerialNumber.updateTestData("KUBS_FAT_UAT_002_005_D1", "Reviewer ID", reviewerID);
	}
	...
	public void store_the_asset_code_in_asset_creation_excel_database() throws Throwable {
		excelDataForAssetCreation.updateTestData("KUBS_FAT_UAT_002_006_D1", "AssetCode", assetSerialNumberTestData.get("AssetCode"));
		excelDataForAssetCreation.updateTestData("KUBS_FAT_UAT_002_007_D1", "AssetCode", assetSerialNumberTestData.get("AssetCode"));
	}
	/*
