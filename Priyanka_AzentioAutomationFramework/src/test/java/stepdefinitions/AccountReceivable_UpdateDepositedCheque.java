...
public class AccountReceivable_UpdateDepositedCheque extends BaseClass { 
	...
	AccountReceivable_UpdateDepositedChequeTestDataType accountReceivable_UpdateDepositedChequeTestDataType = new AccountReceivable_UpdateDepositedChequeTestDataType();
	...
	accountReceivable_UpdateDepositedChequeTestDataType = jsonReader.getUpdateDepositedChequeByName("Maker");	
	...
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_ChequeStatus().sendKeys(accountReceivable_UpdateDepositedChequeTestDataType.ChequeStatusBounced);
	...
	accountReceivable_UpdateDepositedChequeTestDataType = jsonReader.getUpdateDepositedChequeByName("Maker");	
	waithelper.waitForElement(driver, 2000,accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_BankCharges());
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_BankCharges().click();
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_BankCharges().sendKeys(accountReceivable_UpdateDepositedChequeTestDataType.BankCharges);
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_BankCharges().sendKeys(Keys.ENTER);
	...
	accountReceivable_UpdateDepositedChequeTestDataType = jsonReader.getUpdateDepositedChequeByName("Maker");	
	waithelper.waitForElement(driver, 2000,accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_BouncedReason());
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_BouncedReason().click();
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_BouncedReason().sendKeys(accountReceivable_UpdateDepositedChequeTestDataType.BouncedReason);
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_BouncedReason().sendKeys(Keys.ENTER);
   ...
   //Reference
	...
	waithelper.waitForElement(driver, 2000,accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_ChequeStatus());
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_ChequeStatus().click();
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_ChequeStatus().sendKeys(accountReceivable_UpdateDepositedChequeTestDataType.ChequeStatusCleared);
	accountReceivable_UpdateDepositedChequeObj.accountReceivable_UpdateDepositedCheque_ChequeStatus().sendKeys(Keys.ENTER);
