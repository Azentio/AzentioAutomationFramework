...
//	}
	...
	private WebElement assetSale_ListViewApprovedAssetCode;

	public WebElement assetSaleListViewApprovedAssetCode() {
		return assetSale_ListViewApprovedAssetCode;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[5]//span")
	private WebElement assetSale_ListViewApprovedAssetRefereceNumber;

	public WebElement assetSaleListViewApprovedAssetRefereceNumber() {
		return assetSale_ListViewApprovedAssetRefereceNumber;
	}
	@FindBy(xpath="//label[contains(text(),' Asset Code ')]//following-sibling::ng-select//input")
	private WebElement assetSaleReoprt_AssetCodeInputBox;

	public WebElement assetSaleReoprtAssetCodeInputBox() {
		return assetSaleReoprt_AssetCodeInputBox;
	}
	@FindBy(xpath="//span[@class='input-calendar']")
	private WebElement assetSaleReoprt_DateField;

	public WebElement assetSaleReoprtDateField() {
		return assetSaleReoprt_DateField;
	}
