...
//	--------------------------A-S-S-E-T--T-R-A-N-S-F-E-R-----------------------------------//
	...
	private WebElement fixedAsset_TransferOkButton;

	public WebElement fixedAssetTransferOkButton() {
		return fixedAsset_TransferOkButton;
	}
...
//	--------------------------A-S-S-E-T--R-E-V-A-L-U-A-T-I-O-N-----------------------------------//
	...
	private WebElement assetTransfer_SearchAssetReferenceNumber;
