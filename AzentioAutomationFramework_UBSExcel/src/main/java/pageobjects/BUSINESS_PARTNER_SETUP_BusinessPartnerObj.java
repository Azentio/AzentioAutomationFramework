...
public class BUSINESS_PARTNER_SETUP_BusinessPartnerObj {
	...
	@FindBy(xpath="//ion-label[contains(text(),'Corporate')]//parent::ion-tab-button")
	private WebElement businesPartserSetup_CorporateSection;
	public WebElement businesPartserSetupCorporateSection()
	{
		return businesPartserSetup_CorporateSection;
	}
	// Save Button 
	...
	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='BUSINESS_PARTNER']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[1]//span")
	private WebElement businessPartnerSetup_businessPartnerSetupRecordReferenceNo;

	public WebElement businessPartnerSetupReferenceNo() {
		return businessPartnerSetup_businessPartnerSetupRecordReferenceNo;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='BUSINESS_PARTNER']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[2]//ion-button")
	private WebElement businessPartnerSetup_businessPartnerSetupNotificationRecord;

	public WebElement businessPartnerSetupNotificationRecord() {
		return businessPartnerSetup_businessPartnerSetupNotificationRecord;
	}
	
	
	
//corporate
	@FindBy(xpath="//ion-label[contains(text(),'BP Name')]//following-sibling::ion-input//input")
	private WebElement businessPartner_CorporateBpName;
	public WebElement businessPartnerCorporateBpName()
	{
		return businessPartner_CorporateBpName;
	}
	@FindBy(xpath="//ion-label[contains(text(),'Registration Number')]//following-sibling::ion-input//input")
	private WebElement businessPartner_CorporateRegistratonNumber;
	public WebElement businessPartnerCorporateRegistratonNumber()
	{
		return businessPartner_CorporateRegistratonNumber;
	}
	@FindBy(xpath="//label[contains(text(),'Country of Registration')]//following-sibling::ng-select//input")
	private WebElement businessPartner_CorporateCountryofRegistration;
	public WebElement businessPartnerCorporateCountryofRegistration()
	{
		return businessPartner_CorporateCountryofRegistration;
	}
	@FindBy(xpath="//label[contains(text(),'Industry')]//following-sibling::ng-select//input")
	private WebElement businessPartner_CorporateIndustry;
	public WebElement businessPartnerCorporateIndustry()
	{
		return businessPartner_CorporateIndustry;
	}
	@FindBy(xpath="//label[contains(text(),'KYC Compliance')]//following-sibling::ng-select//input")
	private WebElement businessPartner_CorporateKYCCompliance;
	public WebElement businessPartnerCorporateKYCCompliance()
	{
		return businessPartner_CorporateKYCCompliance;
	}
	@FindBy(xpath="//label[contains(text(),'Blacklisted')]//following-sibling::ng-select//input")
	private WebElement businessPartner_CorporateBlackListed;
	public WebElement businessPartnerCorporateBlackListed()
	{
		return businessPartner_CorporateBlackListed;
	}
	
	@FindBy(xpath="//ion-label[contains(text(),'Branch Code')]//following-sibling::ion-input//input")
	private WebElement businessPartner_BranchBranchCode;
	public WebElement businessPartnerBranchBranchCode()
	{
		return businessPartner_BranchBranchCode;
	}
	@FindBy(xpath="//label[contains(text(),'Branch Type')]//following-sibling::ng-select//input")
	private WebElement businessPartner_BranchBranchType;
	public WebElement businessPartnerBranchBranchType()
	{
		return businessPartner_BranchBranchType;
	}
	@FindBy(xpath="//ion-label[contains(text(),'Branch Name')]//following-sibling::ion-input//input")
	private WebElement businessPartner_BranchBranchName;
	public WebElement businessPartnerBranchBranchName()
	{
		return businessPartner_BranchBranchName;
	}
	@FindBy(xpath="//ion-label[contains(text(),'Phone No')]//following-sibling::ion-input//input")
	private WebElement businessPartner_BranchPhoneNo;
	public WebElement businessPartnerBranchPhoneNo()
	{
		return businessPartner_BranchPhoneNo;
	}
	@FindBy(xpath="//ion-label[contains(text(),'Email')]//following-sibling::ion-input//input")
	private WebElement businessPartner_BranchEmail;
	public WebElement businessPartnerBranchEmail()
	{
		return businessPartner_BranchEmail;
	}
	@FindBy(xpath="//ion-label[contains(text(),'Identification')]//parent::ion-tab-button")
	private WebElement businessPartner_IdentificationSection;
	public WebElement businessPartnerIdentificationSection()
	{
		return businessPartner_IdentificationSection;
	}
	@FindBy(xpath="//ion-label[contains(text(),'Bank Account')]//parent::ion-tab-button")
	private WebElement businessPartner_BankAccountSection;
	public WebElement businessPartnerBankAccountSection()
	{
		return businessPartner_BankAccountSection;
	}
	@FindBy(xpath="//ion-label[contains(text(),'HSN/SAC Code Mapping')]//parent::ion-tab-button")
	private WebElement businessPartner_HSNSACCodeMappingSection;
	public WebElement businessPartnerHSNSACCodeMappingSection()
	{
		return businessPartner_HSNSACCodeMappingSection;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[1]//ion-button[1]")
	private WebElement branch_SavedRecord;
	public WebElement branchSavedRecord()
	{
		return branch_SavedRecord;
	}
	@FindBy(xpath="//ion-label[contains(text(),'Branch')]//parent::ion-tab-button")
	private WebElement businessPartner_BranchSection;
	public WebElement businessPartnerBranchSection()
	{
		return businessPartner_BranchSection;
	}
}
