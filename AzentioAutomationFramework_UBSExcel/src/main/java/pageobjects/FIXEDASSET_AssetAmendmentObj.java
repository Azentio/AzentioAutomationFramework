...
public class FIXEDASSET_AssetAmendmentObj {
	...
	private WebElement fixedAmendment_ListViewApprovedRecord;

	public WebElement fixedAmendmentListViewApprovedRecord() {

		return fixedAmendment_ListViewApprovedRecord;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[4]//span")
	private WebElement fixedAmendment_ListViewApprovedAssetReferenceNumber;

	public WebElement fixedAmendmentListViewApprovedAssetReferenceNumber() {

		return fixedAmendment_ListViewApprovedAssetReferenceNumber;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[5]//span")
	private WebElement fixedAmendment_ListViewApprovedAssetCode;

	public WebElement fixedAmendmentListViewApprovedAssetCode() {

		return fixedAmendment_ListViewApprovedAssetCode;
	}
	@FindBy(xpath="//label[contains(text(),' Modification Type ')]//following-sibling::ng-select//div[2]//span[2]")
	private WebElement fixedAmendment_ListViewApprovedModificationType;

	public WebElement fixedAmendmentApprovedModificationType() {

		return fixedAmendment_ListViewApprovedModificationType;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Asset Amendment Report ')]//ancestor::ion-item//ion-button")
	private WebElement fixedAmendment_AssetAmmendmentReportTempView;

	public WebElement fixedAmendmentAssetAmmendmentReportTempView() {

		return fixedAmendment_AssetAmmendmentReportTempView;
	}
	@FindBy(xpath="//label[contains(text(),' Modification Type ')]//following-sibling::ng-select//input")
	private WebElement fixedAmendment_AssetAmmendmentReportModificationType;

	public WebElement assetAmmendmentReportModificationType() {

		return fixedAmendment_AssetAmmendmentReportModificationType;
	}
	@FindBy(xpath="(//span[@class='input-calendar'])[1]")
	private WebElement fixedAmendment_AssetAmmendmentReportcapitalizationDate;

	public WebElement assetAmmendmentReportcapitalizationDate() {

		return fixedAmendment_AssetAmmendmentReportcapitalizationDate;
	}
	@FindBy(xpath="(//span[@class='input-calendar'])[2]")
	private WebElement fixedAmendment_AssetAmmendmentReportAsOndate;

	public WebElement fixedAmendmentAssetAmmendmentReportAsOndate() {

		return fixedAmendment_AssetAmmendmentReportAsOndate;
	}
