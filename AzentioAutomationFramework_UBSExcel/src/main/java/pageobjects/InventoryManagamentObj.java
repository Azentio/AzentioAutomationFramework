...
//		invenotyr codes report 
		...
		private WebElement approvedGRN_Number;
		public WebElement approvedGRNNumber()
		{
			return approvedGRN_Number;
		}
		 	
		
		
		
	@FindBy(xpath="(//span[contains(text(),'GRN_EVENT')]//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[1]//span)[1]")
	private WebElement AccountsPayable_GRNNotificationFirstReferenceNumber;
	public WebElement AccountsPayableGRNNotificationFirstReferenceNumber()
	{
		return AccountsPayable_GRNNotificationFirstReferenceNumber;
	}
	@FindBy(xpath="(//span[contains(text(),'GRN_EVENT')]//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[2]//ion-button)[1]")
	private WebElement AccountsPayable_GRNNotificationFirstRecord;
	public WebElement AccountsPayableGRNNotificationFirstRecord()
	{
		return AccountsPayable_GRNNotificationFirstRecord;
	}
