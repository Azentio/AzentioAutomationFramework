...
//	@FindBy(xpath = "//page-contract-creation-update/ion-header/ion-toolbar/ion-buttons[2]/ion-button")
	...
	// FirstReferenceID
	@FindBy(xpath = "//span[contains(text(),'CONTRACTCREATION_EVT')]//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[1]//span")
	...
	//first Reference ID of billbooking record'
	@FindBy(xpath = "(//span[contains(text(),'AP_BILL_BOOKING')]//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[1]//span)[1]")
	private WebElement accountPayableInvoiceBooking_FirstReferenceId;

	public WebElement accountPayableInvoiceBookingFirstReferenceId() {
		return accountPayableInvoiceBooking_FirstReferenceId;
	}

	@FindBy(xpath = "//span[contains(text(),'CONTRACTCREATION_EVT')]//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[2]//ion-button")
	private WebElement accountPayable_bpFirstRecord;

	public WebElement accountPayablebpFirstRecord() {
		return accountPayable_bpFirstRecord;
	}
	//Invoice booking first record
	@FindBy(xpath = "(//span[contains(text(),'AP_BILL_BOOKING')]//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[2]//ion-button)[1]")
	private WebElement accountPayableInvoiceBooking_FirstRecord;

	public WebElement accountPayableInvoiceBookingFirstRecord() {
		return accountPayableInvoiceBooking_FirstRecord;
	}
...
//	@FindBy(xpath = "//ion-textarea/div/textarea[@name='remarks']")
	...
	private WebElement accountPayable_VendorContracts_VendorContractDetails;

	public WebElement accountPayable_VendorContracts_VendorContractDetails() {
	...
	private WebElement accountPayable_VendorContracts_ApprovedBpName;

	public WebElement accountPayableVendorContractsApprovedBpName() {
		return accountPayable_VendorContracts_ApprovedBpName;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[4]//span")
	private WebElement accountPayable_VendorContracts_ApprovedContarctDesc;

	public WebElement accountPayableVendorContractsApprovedContarctDesc() {
		return accountPayable_VendorContracts_ApprovedContarctDesc;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[3]//span")
	private WebElement accountPayable_VendorContracts_ApprovedContractNumber;

	public WebElement accountPayableVendorContractsApprovedContractNumber() {
		return accountPayable_VendorContracts_ApprovedContractNumber;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[6]//span")
	private WebElement accountPayable_VendorContracts_ApprovedContractBpName;

	public WebElement accountPayableVendorContractsApprovedContractBpName() {
		return accountPayable_VendorContracts_ApprovedContractBpName;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[7]//span")
	private WebElement accountPayable_VendorContracts_ApprovedContractAsOndate;

	public WebElement accountPayableVendorContractsApprovedContractAsOndate() {
		return accountPayable_VendorContracts_ApprovedContractAsOndate;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[8]//span")
	private WebElement accountPayable_VendorContracts_ApprovedContractStatus;

	public WebElement accountPayableVendorContractsApprovedContractStatus() {
		return accountPayable_VendorContracts_ApprovedContractStatus;
	}
	@FindBy(xpath="//label[contains(text(),' Vendor/Employee Name ')]//following-sibling::ng-select//input")
	private WebElement accountPayable_VendorContractsReportsVendorEmployeeName;

	public WebElement accountPayableVendorContractsReportsVendorEmployeeName() {
		return accountPayable_VendorContractsReportsVendorEmployeeName;
	}
	@FindBy(xpath="//span[@class='input-calendar']")
	private WebElement accountPayable_VendorContractsReportsContractAsOnDate;

	public WebElement accountPayableVendorContractsReportsContractAsOnDate() {
		return accountPayable_VendorContractsReportsContractAsOnDate;
	}
	@FindBy(xpath="//label[contains(text(),' Contract Status ')]//following-sibling::ng-select//input")
	private WebElement accountPayable_VendorContractsReportsContractStatus;

	public WebElement accountPayableVendorContractsReportsContractStatus() {
		return accountPayable_VendorContractsReportsContractStatus;
	}
