...
public class FixedAsset_AssetCategoryObj {
	...
	@FindBy(xpath = "//label[contains(text(),' Asset Sub Category ')]//following-sibling::ng-select//span[@class='ng-arrow-wrapper']")
	private WebElement fixedAssetAssetSubCategory_Arrow;

	public WebElement fixedAssetAssetSubCategoryDownArrow() {
		return fixedAssetAssetSubCategory_Arrow;
	}

	@FindBy(xpath = "//ion-title[contains(text(),' Asset Category ')]")
	private WebElement fixedAssetCategory_Label;

	public WebElement fixedAssetCategoryLabel() {
		return fixedAssetCategory_Label;
	}
	...
	public WebElement fixedAssetCategorySearchButton() {
		return fixedAssetcategory_SerahcButton;
	}

	@FindBy(xpath = "//input[@placeholder='Search eventCode']")
	private WebElement fixedAssetcategory_EventCode;

	public WebElement fixedAssetcategoryEventCode() {
		return fixedAssetcategory_EventCode;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='ASSET_CATEGORY']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[1]//span")
	private WebElement assetCategory_ReferenceNumber;

	public WebElement assetCategoryReferenceNumber() {
		return assetCategory_ReferenceNumber;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='ASSET_CATEGORY']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[2]//ion-button")
	private WebElement assetCategory_NotificationRecord;

	public WebElement assetCategoryNotificationRecord() {
		return assetCategory_NotificationRecord;
	}

	@FindBy(xpath = "//div[@id='toast-container']/div/div[1]")
	private WebElement assetCategory_ReviewerID;

	public WebElement assetCategoryReviewerID() {
		return assetCategory_ReviewerID;
	}

	@FindBy(xpath = "//ion-label[contains(text(),' Asset category report ')]//ancestor::ion-item//following-sibling::ion-buttons//ion-button")
	private WebElement assetCategory_ReporTempView;

	public WebElement assetCategoryReporTempView() {
		return assetCategory_ReporTempView;
	}

	@FindBy(xpath = "//span[@class='input-calendar']")
	private WebElement assetCategory_ReportCategoryAsOnDate;

	public WebElement assetCategoryReportCategoryAsOnDate() {
		return assetCategory_ReportCategoryAsOnDate;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[5]//span")
	private WebElement assetCategory_ReportCategoryApprovedItemCategory;

	public WebElement assetCategory_ReportCategoryApprovedItemCategory() {
		return assetCategory_ReportCategoryApprovedItemCategory;
	}
