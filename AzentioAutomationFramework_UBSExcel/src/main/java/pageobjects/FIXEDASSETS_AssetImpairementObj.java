...
public class FIXEDASSETS_AssetImpairementObj {
	...
	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='FIXED_ASSET_IMPAIRWO']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[1]//span")
	private WebElement assetImapirment_ReferenceNumber;

	public WebElement assetImapirmentReferenceNumber() {
		return assetImapirment_ReferenceNumber;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='FIXED_ASSET_IMPAIRWO']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[2]//ion-button")
	private WebElement assetImpairment_NotificationFirstRecord;

	public WebElement assetImpairmentNotificationFirstRecord() {
		return assetImpairment_NotificationFirstRecord;
	}

	@FindBy(xpath = "//input[@placeholder='Search Reference Number']")
	private WebElement assetImpairment_ListViewSearchAssetReferenceNumber;

	public WebElement assetImpairmentListViewSearchAssetReferenceNumber() {
		return assetImpairment_ListViewSearchAssetReferenceNumber;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[5]//span")
	private WebElement assetImpairment_ListViewApprovedAssetReferenceNumber;

	public WebElement assetImpairmentListViewApprovedAssetReferenceNumber() {
		return assetImpairment_ListViewApprovedAssetReferenceNumber;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[13]//span")
	private WebElement assetImpairment_ListViewApprovedDate;

	public WebElement assetImpairmentListViewApprovedDate() {
		return assetImpairment_ListViewApprovedDate;
	}

	@FindBy(xpath = "//span[@class='input-calendar']")
	private WebElement assetImpairment_ImpairementAsOnDate;

	public WebElement assetImpairmentImpairementAsOnDate() {
		return assetImpairment_ImpairementAsOnDate;
	}

	@FindBy(xpath = "//ion-label[text()=' Asset revaluation ']//following-sibling::ion-buttons//ion-button[2]")
	private WebElement fixedAssetRevaluationViewIcon;

	public WebElement fixedAssetRevaluationViewIcon() {
		return fixedAssetRevaluationViewIcon;
	}

	@FindBy(xpath = "//ion-label[contains(text(),'Assets re-valuation report')]//ancestor::ion-item//ion-button")
	private WebElement assetsRevaluationReportTempView;

	public WebElement assetsRevaluationReportTempView() {
		return assetsRevaluationReportTempView;
	}
}
