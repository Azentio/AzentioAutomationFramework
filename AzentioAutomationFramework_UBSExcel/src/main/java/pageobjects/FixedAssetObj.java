...
public class FixedAssetObj {
	...
	private WebElement kubs_SearchButton;

	public WebElement kubsSearchButton() {
		return kubs_SearchButton;
	}

	@FindBy(xpath = "//input[@placeholder='Search Asset Code']")
	private WebElement fixedAsset_SearchAssetCode;

	public WebElement fixedAssetSearchAssetCode() {
		return fixedAsset_SearchAssetCode;
	}
...
// search record 
	...
	@FindBy(xpath="//label[contains(text(),' GRN Reference No ')]//following-sibling::ng-select//input")
	private WebElement fixedAsset_AssetCreation_GRNReferenceNumberTextBox;

	public WebElement fixedAsset_AssetCreationGRNReferenceNumberTextBox() {
		return fixedAsset_AssetCreation_GRNReferenceNumberTextBox;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Asset Contract Linkage ')]//parent::ion-tab-button")
	private WebElement fixedAsset_AssetCreation_AssetContractLinkageTab;

	public WebElement fixedAsset_AssetCreationAssetContractLinkageTab() {
		return fixedAsset_AssetCreation_AssetContractLinkageTab;
	}
	@FindBy(xpath="//label[contains(text(),' PO Reference No ')]//following-sibling::ng-select//input")
	private WebElement fixedAsset_AssetCreation_ContractLinkagePoNumberTextBox;

	public WebElement fixedAsset_AssetCreationContractLinkagePoNumberTextBox() {
		return fixedAsset_AssetCreation_ContractLinkagePoNumberTextBox;
	}
...
//page-fixed-asset-creation-item-dtl-update//ion-toolbar//ion-button
	...
	@FindBy(xpath = "//ion-icon[@title='Enable Search']")
	private WebElement FixedAsset_MailBoxSearchButton;

	public WebElement fixedAssetMailBoxSearchButton() {
		return FixedAsset_MailBoxSearchButton;
	}

	@FindBy(xpath = "//input[@placeholder='Search eventCode']")
	private WebElement fixedAsset_SearchEventCode;

	public WebElement fixedAssetSearchEventCode() {
		return fixedAsset_SearchEventCode;
	}
...
//-------------anand page obj--------
	...
	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='ASSET_CREATION']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[1]//span")
	private WebElement assetCreation_ReferenceNumber;

	public WebElement assetCreationReferenceNumber() {
		return assetCreation_ReferenceNumber;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='ASSET_CREATION']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[2]//ion-button")
	private WebElement assetCreation_NotificationFirstRecord;

	public WebElement assetCreationNotificationFirstRecord() {
		return assetCreation_NotificationFirstRecord;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='FIXED_ASSET_ALLO']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[1]//span")
	private WebElement assetAllocation_ReferenceNumber;

	public WebElement assetAllocationReferenceNumber() {
		return assetAllocation_ReferenceNumber;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//span[text()='FIXED_ASSET_ALLO']//ancestor::datatable-body-cell//preceding-sibling::datatable-body-cell[2]//ion-button")
	private WebElement assetAllocation_NotificationFirstRecord;

	public WebElement assetAllocationNotificationFirstRecord() {
		return assetAllocation_NotificationFirstRecord;
	}

	@FindBy(xpath = "//input[@placeholder='Search Asset Reference No']")
	private WebElement assetAllocation_ListViewSearchAssetReferenceNumber;

	public WebElement assetAllocationListViewSearchAssetReferenceNumber() {
		return assetAllocation_ListViewSearchAssetReferenceNumber;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[1]//ion-button[1]")
	private WebElement assetAllocation_ListViewFirstRecord;

	public WebElement assetAllocationListViewFirstRecord() {
		return assetAllocation_ListViewFirstRecord;
	}

	@FindBy(xpath = "//label[contains(text(),' Asset Reference Number ')]//following-sibling::ng-select//div[2]//span[2]")
	private WebElement assetAllocation_AllocatedReferenceNumber;

	public WebElement assetAllocationAllocatedReferenceNumber() {
		return assetAllocation_AllocatedReferenceNumber;
	}

	@FindBy(xpath = "//label[contains(text(),' Employee Id ')]//following-sibling::ng-select//div[2]//span[2]")
	private WebElement assetAllocation_AllocatedEmployeeID;

	public WebElement assetAllocationAllocatedEmployeeID() {
		return assetAllocation_AllocatedEmployeeID;
	}

	@FindBy(xpath = "//label[contains(text(),' Item Number ')]//following-sibling::ng-select//div[2]//span[2]")
	private WebElement assetAllocation_AllocatedItemNumber;

	public WebElement assetAllocationAllocatedItemNumber() {
		return assetAllocation_AllocatedItemNumber;
	}

	@FindBy(xpath = "//ion-label[contains(text(),' Asset allocation report ')]//ancestor::ion-item//following-sibling::ion-buttons//ion-button")
	private WebElement assetAllocation_AllocationReportTemp;

	public WebElement assetAllocationAllocationReportTemp() {
		return assetAllocation_AllocationReportTemp;
	}

	@FindBy(xpath = "//label[contains(text(),'Employee ID')]//following-sibling::ng-select//input")
	private WebElement assetAllocation_AllocationReportEmployeeID;

	public WebElement assetAllocationAllocationReportEmployeeID() {
		return assetAllocation_AllocationReportEmployeeID;
	}

	@FindBy(xpath = "//label[contains(text(),'Item Number')]//following-sibling::ng-select//input")
	private WebElement assetAllocation_AllocationReportItemNumber;

	public WebElement assetAllocationAllocationReportItemNumber() {
		return assetAllocation_AllocationReportItemNumber;
	}

	@FindBy(xpath = "//span[@class='input-calendar']")
	private WebElement assetAllocation_AllocationReportAllocatedDate;

	public WebElement assetAllocationAllocationReportAllocatedDate() {
		return assetAllocation_AllocationReportAllocatedDate;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[4]//span")
	private WebElement assetcreationListView_ApprovedAssetCode;

	public WebElement assetCreationListViewApprovedAssetCode() {
		return assetcreationListView_ApprovedAssetCode;
	}
	

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[6]//span")
	private WebElement assetcreationListView_ApprovedAssetReferenceNumber;

	public WebElement assetcreationListViewApprovedAssetReferenceNumber() {
		return assetcreationListView_ApprovedAssetReferenceNumber;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[3]//span")
	private WebElement assetcreationListView_ApprovedAssetBranch;

	public WebElement assetcreationListViewApprovedAssetBranch() {
		return assetcreationListView_ApprovedAssetBranch;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[1]//ion-button[1]")
	private WebElement assetcreationListView_ApprovedAssetRecord;

	public WebElement assetcreationListViewApprovedAssetRecord() {
		return assetcreationListView_ApprovedAssetRecord;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[1]//ion-button[1]")
	private WebElement assetcreationListView_ApprovedAssetItemRecord;

	public WebElement assetcreationListViewApprovedAssetItemRecord() {
		return assetcreationListView_ApprovedAssetItemRecord;
	}

	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[2]//span")
	private WebElement assetcreationListView_ApprovedAssetItemNumber;

	public WebElement assetcreationListViewApprovedAssetItemNumber() {
		return assetcreationListView_ApprovedAssetItemNumber;
	}
	@FindBy(xpath="(//span[@class='input-calendar'])[1]")
	private WebElement assetcreationLReport_CapitalizationDateCalendar;

	public WebElement assetcreationLReportCapitalizationDateCalendar() {
		return assetcreationLReport_CapitalizationDateCalendar;
	}
	@FindBy(xpath="(//span[@class='input-calendar'])[2]")
	private WebElement assetcreationLReport_AssetCreationAsOnDateCalendar;

	public WebElement assetcreationLReportAssetCreationAsOnDateCalendar() {
		return assetcreationLReport_AssetCreationAsOnDateCalendar;
	}
	@FindBy(xpath="//label[contains(text(),' Asset Life Unit  ')]//following-sibling::ng-select//div[2]//span[2]")
	private WebElement assetcreationApproved_AssetCreationAssetLife;

	public WebElement assetcreationApprovedAssetCreationAssetLife() {
		return assetcreationApproved_AssetCreationAssetLife;
	}
	@FindBy(xpath="//label[contains(text(),'Asset Life Unit ')]//following-sibling::ng-select//input")
	private WebElement assetCreation_CommonReport_AssetLifeUnit;

	public WebElement assetCreationCommonReport_AssetLifeUnit() {
		return assetCreation_CommonReport_AssetLifeUnit;
	}
	@FindBy(xpath="//span[@class='input-calendar']")
	private WebElement assetCreation_CommonReportAsOnDate;

	public WebElement assetCreationCommonReportAsOnDate() {
		return assetCreation_CommonReportAsOnDate;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Branch level depreciation ')]//parent::ion-item//ion-buttons//ion-button[2]")
	private WebElement fixedAssetBranchLevelDepriciation_ListView;

	public WebElement fixedAssetBranchLevelDepriciationListView() {
		return fixedAssetBranchLevelDepriciation_ListView;
	}
	@FindBy(xpath="//input[@placeholder='Search Branch Code']")
	private WebElement fixedAssetBranchLevelDepriciation_SearchBranchCode;

	public WebElement fixedAssetBranchLevelDepriciationSearchBranchCode() {
		return fixedAssetBranchLevelDepriciation_SearchBranchCode;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[4]//span")
	private WebElement fixedAssetBranchLevelDepriciation_ListViewDepriciationPeriod;

	public WebElement fixedAssetBranchLevelDepriciationListViewDepriciationPeriod() {
		return fixedAssetBranchLevelDepriciation_ListViewDepriciationPeriod;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Depreciation ')]//parent::ion-item//ion-buttons//ion-button[1]")
	private WebElement depriciationReport_TempView;

	public WebElement depriciationReportTempView() {
		return depriciationReport_TempView;
	}
	@FindBy(xpath="//label[contains(text(),' Branch ')]//following-sibling::ng-select//input")
	private WebElement depriciationReport_BranchInput;

	public WebElement depriciationReportBranchInput() {
		return depriciationReport_BranchInput;
	}
	@FindBy(xpath="//span[@class='input-calendar']")
	private WebElement depriciationReport_DepriciationCalendar;

	public WebElement depriciationReportDepriciationCalendar() {
		return depriciationReport_DepriciationCalendar;
	}
	@FindBy(xpath="//label[contains(text(),' Depreciation Period ')]//following-sibling::ng-select//input")
	private WebElement depriciationReport_DepriciationPeriod;

	public WebElement depriciationReportDepriciationPeriod() {
		return depriciationReport_DepriciationPeriod;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Asset limit configuration report ')]//parent::ion-item//ion-buttons//ion-button")
	private WebElement assetLimit_ReportTempView;

	public WebElement assetLimitReportTempView() {
		return assetLimit_ReportTempView;
	}
	@FindBy(xpath="//label[contains(text(),' Accounting Standards ')]//following-sibling::ng-select//input")
	private WebElement assetLimit_AccountingStandards;

	public WebElement assetLimitAccountingStandards() {
		return assetLimit_AccountingStandards;
	}
	@FindBy(xpath="//span[@class='input-calendar']")
	private WebElement assetLimit_LimitAsOnDate;
 
	public WebElement assetLimitLimitAsOnDate() {
		return assetLimit_LimitAsOnDate;
	}
}
