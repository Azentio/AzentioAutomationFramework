...
public class FIXEDASSET_AssetReplacementObj {
	...
	private WebElement assetReplacement_ListViewApprovedRecord;
	public WebElement assetReplacementListViewApprovedRecord()
	{
		return assetReplacement_ListViewApprovedRecord;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[8]//span")
	private WebElement assetReplacement_ListViewApprovedDate;
	public WebElement assetReplacementListViewApprovedDate()
	{
		return assetReplacement_ListViewApprovedDate;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[5]//span")
	private WebElement assetReplacement_ListViewApprovedItemNumber;
	public WebElement assetReplacementListViewApprovedItemNumber()
	{
		return assetReplacement_ListViewApprovedItemNumber;
	}
	@FindBy(xpath="//datatable-row-wrapper[1]//datatable-body-cell[4]//span")
	private WebElement assetReplacement_ListViewApprovedAssetReferenceNumberr;
	public WebElement assetReplacementListViewApprovedAssetReferenceNumberr()
	{
		return assetReplacement_ListViewApprovedAssetReferenceNumberr;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Asset replacement report ')]//ancestor::ion-item//ion-button")
	private WebElement assetReplacement_ReportTempView;
	public WebElement assetReplacementReportTempView()
	{
		return assetReplacement_ReportTempView;
	}
	@FindBy(xpath="//label[contains(text(),' Asset Code ')]//following-sibling::ng-select//input")
	private WebElement assetReplacement_ReportAssetCode;
	public WebElement assetReplacementReportAssetCode()
	{
		return assetReplacement_ReportAssetCode;
	}
	@FindBy(xpath="//label[contains(text(),' Item Number ')]//following-sibling::ng-select//input")
	private WebElement assetReplacement_ReportItemNumber;
	public WebElement assetReplacementReportItemNumber()
	{
	...
	{
		return assetReplacement_ReportCreatedCalendar;
	}
