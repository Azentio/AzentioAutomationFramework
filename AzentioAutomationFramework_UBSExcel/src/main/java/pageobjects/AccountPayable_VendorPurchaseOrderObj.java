...
public class AccountPayable_VendorPurchaseOrderObj {
	...
	private WebElement accountPayable_VendorPurchaseOrder_approvedPo;

	public WebElement accountPayableVendorPurchaseOrderapprovedPo() {
		return accountPayable_VendorPurchaseOrder_approvedPo;
	}
	@FindBy(xpath = "//datatable-row-wrapper[1]//datatable-body-cell[7]//span")
	private WebElement accounstPayable_PoCreation_BpName;

	public WebElement accounstPayablePoCreationBpName() {
		return accounstPayable_PoCreation_BpName;
	}
