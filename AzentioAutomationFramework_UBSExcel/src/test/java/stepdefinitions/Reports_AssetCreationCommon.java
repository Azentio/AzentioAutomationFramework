...
public class Reports_AssetCreationCommon {
	...
	public void user_should_navigate_to_reports_menu() {
		...
		waithelper.waitForElement(driver, 3000,
				reports_AssetCreationCommonObj.Report_AssetCreationCommon_ReportsMenu());
	...
	public void click_on_temp_grid_button_of_asset_creation_common() {
		waithelper.waitForElement(driver, 3000,
				reports_AssetCreationCommonObj.Report_AssetCreationCommon_AssetCreationCommonTempView());
...
//----------	Check depreciation
	...
	public void click_on_temp_grid_button_of_depreciation() {
		waithelper.waitForElement(driver, 3000,
				reports_AssetCreationCommonObj.Report_AssetCreationCommon_DepreciationTempView());
...
//	}
	...
	public void the_report_is_displaying_all_the_asset_depreciation_details_for_a_branch() throws InterruptedException {
		...
		waithelper.waitForElement(driver, 10000,
				reports_AssetCreationCommonObj.Report_Depreciation_DepreciationReport());
...
//-------------------	asset contract
	...
	public void click_on_temp_grid_button_of_asset_contract() {
		waithelper.waitForElement(driver, 3000,
				reports_AssetCreationCommonObj.Report_AssetCreationCommon_AssetContractTempView());
...
//	}
	...
	public void the_report_is_displaying_all_the_asset_contract_details_for_a_branch() throws InterruptedException {
		...
		browserHelper.SwitchToWindow(1);
		waithelper.waitForElement(driver, 10000,
				reports_AssetCreationCommonObj.Report_AssetContract_AssetContractReport());
...
//-----------    Asset Transfer
	...
	public void click_on_temp_grid_button_of_asset_transfer() {
		waithelper.waitForElement(driver, 3000,
				reports_AssetCreationCommonObj.Report_AssetCreationCommon_AssetTransferTempView());
...
//    }
	...
	public void the_report_is_displaying_all_the_asset_transfer_details_for_a_branch() throws InterruptedException {
		...
		browserHelper.SwitchToWindow(1);
		waithelper.waitForElement(driver, 10000,
				reports_AssetCreationCommonObj.Report_AssetTransfer_AssetTransferReport());
	...
	public void verify_the_accounts_payable_report_must_correctly_displayed()
		...
		for (int i = 0; i < 5; i++) {
			try {
				...
				waithelper.waitForElement(driver, 3000,
						reports_AssetCreationCommonObj.Report_AccountPayableReport_NextPage());
...
//	}
	...
	public void select_the_accounting_standards_date_to_check_the_asset_limit_are_displaying()
...

		{
...

			{
				...
				waithelper.waitForElement(driver, 3000,
						driver.findElement(By.xpath("//span[contains(text(),'" + limitconfig.get("AssetCategoryToMonth")
	...
	public void user_get_the_assert_code_in_fixed_assert_config() throws Throwable {
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				reports_AssetCreationCommonObj.AssertReport_AssertCode(), 20, 1);
