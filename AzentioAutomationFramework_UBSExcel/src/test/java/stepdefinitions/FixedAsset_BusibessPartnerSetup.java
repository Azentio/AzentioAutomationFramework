...
public class FixedAsset_BusibessPartnerSetup extends BaseClass {
	...
	public void click_on_business_partner_setup_main_menu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				businessPartnerObj.bUSINESS_PARTNER_SETUP_BusinessPartner_Menu());
	...
	public void click_on_business_partner_view_icon() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_EyeButton());
	...
	public void click_on_add_button_in_businesspartner_setup() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_AddButton());
		for (int i = 0; i <= 500; i++) {
			try {
	...
	public void enter_the_reference_code_no_in_business_partner_setup() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_ReferenceCodeNumber());
		businessPartnerObj.businessPartner_ReferenceCodeNumber().sendKeys(referenceCode);
	}
	...
	public void enter_the_birth_date_in_individual_tab() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_BirthDateCalender());
	...
	public void enter_the_first_name_in_individual_tab() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_FirstName());
	...
	public void enter_the_middle_name_in_individual_tab() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_MiddleName());
	...
	public void enter_last_name_in_individual_tab() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_LastName());
	...
	public void save_the_individual_record() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_IndividualSaveButton());
	...
	public void enter_bp_name_in_corporate_section() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartnerCorporateBpName());
	...
	public void enter_the_registeration_number_in_corporate_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartnerCorporateRegistratonNumber());
	...
	public void save_the_corporate_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_SaveButton());
	...
	public void enter_the_brance_code_in_branch_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartnerBranchBranchCode());
	...
	public void enter_the_branch_name_in_branch_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartnerBranchBranchName());
	...
	public void enter_the_phone_number_in_branch_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartnerBranchPhoneNo());
	...
	public void enter_the_email_in_branch_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartnerBranchEmail());
	...
	public void enter_the_id_number_in_identification_section() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_ID_Number());
	...
	public void enter_the_account_no_in_bank_account_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_AccountNumber());
	...
	public void enter_the_remark_in_bank_acount_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_BankAccountRemark());
	...
	public void enter_the_hsn_sac_code_in_code_mapping_section() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_HSN_Code());
	...
	public void enter_the_remark_in_hsn_code_mapping_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_HSN_CodeRemark());
	...
	public void select_the_recently_saved_branch_record() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.branchSavedRecord());
	...
	public void enter_the_contact_type_in_contact_section() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_Contact());
	...
	public void enter_the_contact_persion_in_contact_sectiobn() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_ContactPerson());
	...
	public void check_the_communication_tab() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_CommunicationContact());
	...
	public void enter_the_mobile_one_in_contact_section() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_Mobile1());
    ...
    public void enter_the_mobile_two_in_contac_section() throws Throwable {
		double mobileNo = Double.valueOf(busniessPartnerTestData.get("Mobile1"));
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_Mobile2());
		businessPartnerObj.businessPartner_Mobile2().sendKeys(String.format("%.0f", mobileNo));
    }
	...
	public void enter_the_phone_one_in_contact_section() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_Phone1());
	...
	public void enter_the_emil_one_in_contact_section_a() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartner_Email1());
	...
	public void store_the_record_reference_number_of_business_partner_record_in_excel_database() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartnerSetupReferenceNo());
	...
	public void select_the_business_partner_record_in_maker_notification() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, businessPartnerObj.businessPartnerSetupNotificationRecord());
	...
	public void store_the_reviewer_id_in_business_partner_excel_database() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, kubsCommonObj.kubsAlertClose());
	...
	public void verify_approved_business_partner_should_reflect_in_maker_list_view() throws Throwable {
		String xpath = "//datatable-row-wrapper[1]//datatable-body-cell[3]//span[contains(text(),'"
