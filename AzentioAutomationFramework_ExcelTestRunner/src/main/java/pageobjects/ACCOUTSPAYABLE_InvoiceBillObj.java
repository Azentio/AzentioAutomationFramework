...
public class ACCOUTSPAYABLE_InvoiceBillObj {
	WebDriver driver;

	public ACCOUTSPAYABLE_InvoiceBillObj(WebDriver driver) {
		this.driver = driver;
...
//	@FindBy(xpath = "//page-billing-expense-update/ion-header/ion-toolbar/ion-buttons[1]/ion-button")
	...
	private WebElement alert_SubmitButton;

	public WebElement alertSubmitButton() {
		return alert_SubmitButton;
	}
	//@FindBy(xpath="")
