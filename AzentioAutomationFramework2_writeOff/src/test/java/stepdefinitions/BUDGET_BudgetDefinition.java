...
public class BUDGET_BudgetDefinition extends BaseClass {
	...
	public void navigate_to_url_and_login_as_a_and_choose_finance_option() throws InterruptedException {
		...
		// function from KUBS_Login this user argument denote the which type of user we
		// have to login
	...
	public void enter_budget_type() {
		/*
		 * This step we can choose our budget type. We have four type of budget code. As
		 * per our test data we can match with our condition and coose it accordingly
		 */
	...
	public void enter_warning_percentage() {
		// This step we can enter our warning percentage warning percentage must be with
		// in 0 to 100 only
	...
	public void give_remark() {
		// this step we can enter the remark in remark field which is appear in the
	...
	public void click_on_save_button() throws InterruptedException {
		...
		/*
		 * String variable successmsg1 ,successmsg2 are store the alert message's text
		 * which is appearing after we save our budget record We have to locate that and
		 * ensure our record got save or not
		 */
	...
	public void select_the_first_record() throws IOException {
		...
		/*
		 * This step we have to select the first record Before selecting the first
		 * record we have to store the reference ID into one file because we can access
		 * this reference ID in Reviewer stage and checker stage
		 * addReferenceData(String) --> This function is used to store the reference
	...
	public void click_on_submit_button() {
		// after select the record in notification we have to submit the record in maker
		// stage
	...
	public void enter_remark_in_alert_tab() {
		javascripthelper.JavaScriptHelper(driver);
		// While we submit our record one alert will open we have to give the remark in
		// alert
	...
	public void click_on_submit() {
		...
		catch(ElementClickInterceptedException clickErro)
		{
			waitHelper.waitForElement(driver, 2000, budgetCreationObj.budgetCreation_AlertRemarks());
			javascripthelper.JSEClick(budgetCreationObj.budgetCreation_AlertRemarks());
			budgetCreationObj.budgetCreation_AlertRemarks().sendKeys(budgetDefinitionTestData.remark);
	...
	public void click_on_submit_button_save_the_reviewer_id() throws IOException {
		 ...
		 * reviewer ID is extracted with one dot) By the help of that string buffer
		 * class we can remove that dot
		 */
	...
	public void update_the_budget_budget_type() {
		...
		/*
		 * In This step we can choose the budget type which is matching with the test
		 * data budget type
		 */
	...
	public void click_on_save_after_update_all_the_details() throws InterruptedException {
		...
		/*
		 * Here we use that sucessmsg 1 and 2 are the alert messages which is appearing
		 * after saving our record
		 */
	...
	/*
	 * 
	 * Here after all the steps are applicable for auto auth steps except
	 * modification history because sape steps were followed in auto auth and multi
	 * auth to see the modification history
	 * 
	 * 
	 */
	...
	// This steps are to see the modification history Both the two authentication
	// status
	/*
	 * 
	 * Line numbers are 391 to 482 This steps are used to system should show the
	 * autorized details in not editable mode(Which the list is inside in the eye
	 * icon of budget definition module)
	 */
		...
		for (int i = 1; i <= 35; i++) {
			try {
				waitHelper.waitForElement(driver, 3000, driver.findElement(
						By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode + "')]")));
				WebElement budgetCode = driver.findElement(
						By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode + "')]"));
	...
	public void verify_system_should_display_the_status_of_the_record() throws Throwable {
		waitHelper.waitForElement(driver, 3000,
				driver.findElement(By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode
						+ "')]/ancestor::datatable-body-cell/following-sibling::datatable-body-cell[3]//span")));
		WebElement statusOfBudget = driver
				.findElement(By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode
						+ "')]/ancestor::datatable-body-cell/following-sibling::datatable-body-cell[3]//span"));
	...
	public void verify_system_should_display_the_name_or_id_who_created_the_record() throws Throwable {
		WebElement budgetCreatorID = driver
				.findElement(By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode
	...
	public void verify_system_should_display_record_created_date() throws Throwable {
		WebElement budgetCreatedDate = driver
				.findElement(By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode
	...
	public void verify_system_should_display_the_name_or_id_who_made_changes_the_record_at_last() throws Throwable {
		WebElement modifierName = driver
				.findElement(By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode
	...
	public void verify_system_should_display_record_modified_date() throws Throwable {
		WebElement modifiedDate = driver
				.findElement(By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode
	...
	public void verify_system_should_display_name_or_id_of_the_authorized_person_of_that_record() throws Throwable {
		javascripthelper.JavaScriptHelper(driver);
		WebElement authorizedBy = driver
				.findElement(By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode
	...
	public void verify_system_should_diplay_the_authorized_date() throws Throwable {
		WebElement authorizedDate = driver
				.findElement(By.xpath("//span[contains(text(),'" + budgetDefinitionTestData.historyBudgetCode
	...
	/*
	 * In auto auth verify maker can able to create multiple budget code Starting
	 * line:497-Ending line:547--> Inside this line codings are used to create the
	 * multiple budget code in auto auth
	 */
...
//BudgetCodeUpdation
	...
	public void select_the_budget_code_in_the_search_result() throws Throwable {
		...
		budgetCode = driver
				.findElement(By.xpath(befor_xpath + budgetDefinitionTestData.updatedBudgetCode + after_xpath));
...
//invalid details to create budget code
	...
	public void click_on_approve_button() throws Throwable {
		...
		/*
		 * This step represent approve the record in auto auth configuration In auto
		 * auth we can approve our budget record in maker itself
		 *
		 */
	...
	public void navigate_to_uat_environment_and_login_as_a_maker_and_choose_finance_option() throws Throwable {
		driver.get(configFileReader.getApplicationUrl());
		kubsLogin = new KUBS_Login(driver);
		kubsLogin.loginToAzentioApp(user);
		javascripthelper.JavaScriptHelper(driver);
	...
	@And("^choose yearly budget$")
	public void choose_yearly_budget() throws Throwable {
