...
public class INVENTORY_InventoryStcokIssue extends BaseClass {
	...
	public void enter_inventory_item() throws Throwable {
		...
		String inventoryItem=jsonData.readInventoryItem();
		String[] invenItem=inventoryItem.split("-");
		inventoryStockIssue.inventoryInventoryItem().sendKeys(invenItem[0].trim());
